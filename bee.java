...
extends beb {
    ...
    protected bee(adm adm2, double d2, double d3, double d4, double d5, double d6, double d7) {
    ...
    public void t_() {
        ...
        this.w *= (double)0.96f;
        this.x *= (double)0.96f;
        wn wn2 = this.o.a((pk)this, 2.0);
        if (wn2 != null && this.t > wn2.aR().b) {
            this.t += (wn2.aR().b - this.t) * 0.2;
            this.w += (wn2.w - this.w) * 0.2;
    ...
    implements bed {
        ...
        public beb a(int n2, adm adm2, double d2, double d3, double d4, double d5, double d6, double d7, int ... nArray) {
            return new bee(adm2, d2, d3, d4, d5, d6, d7);
        }
    }
}
