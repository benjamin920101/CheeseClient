...
extends beb {
    ...
    private beh(adm adm2, double d2, double d3, double d4, double d5, double d6, double d7) {
        this(adm2, d2, d3, d4, d5, d6, d7, 1.0f);
    }

    protected beh(adm adm2, double d2, double d3, double d4, double d5, double d6, double d7, float f2) {
        ...
        this.w += d6;
        this.x += d7;
        this.as = this.at = (float)(Math.random() * (double)0.3f);
        this.ar = this.at;
        this.h *= 0.75f;
        this.h *= f2;
        this.a = this.h;
    ...
    implements bed {
        ...
        public beb a(int n2, adm adm2, double d2, double d3, double d4, double d5, double d6, double d7, int ... nArray) {
            return new beh(adm2, d2, d3, d4, d5, d6, d7);
        }
    }
}
