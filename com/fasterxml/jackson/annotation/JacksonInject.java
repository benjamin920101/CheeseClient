...
public @interface JacksonInject {
    ...
    Serializable {
        ...
        protected Value(Object id2, Boolean useInput) {
            this._id = id2;
        ...
        public static Value construct(Object id2, Boolean useInput) {
            if ("".equals(id2)) {
                id2 = null;
            }
            if (Value._empty(id2, useInput)) {
                return EMPTY;
            }
            return new Value(id2, useInput);
        }
        ...
        public static Value forId(Object id2) {
            return Value.construct(id2, null);
        }

        public Value withId(Object id2) {
            if (id2 == null ? this._id == null : id2.equals(this._id)) {
                return this;
            }
            return new Value(id2, this._useInput);
        }
        ...
        public int hashCode() {
            int h2 = 1;
            if (this._id != null) {
                h2 += this._id.hashCode();
            }
            if (this._useInput != null) {
                h2 += this._useInput.hashCode();
            }
            return h2;
        }
        ...
        private static boolean _empty(Object id2, Boolean useInput) {
            return id2 == null && useInput == null;
        }
    }
}
