...
implements Serializable {
    ...
    public void encodeBase64Chunk(StringBuilder sb2, int b24) {
        sb2.append(this._base64ToAsciiC[b24 >> 18 & 0x3F]);
        sb2.append(this._base64ToAsciiC[b24 >> 12 & 0x3F]);
        sb2.append(this._base64ToAsciiC[b24 >> 6 & 0x3F]);
        sb2.append(this._base64ToAsciiC[b24 & 0x3F]);
    }
    ...
    public void encodeBase64Partial(StringBuilder sb2, int bits, int outputBytes) {
        sb2.append(this._base64ToAsciiC[bits >> 18 & 0x3F]);
        sb2.append(this._base64ToAsciiC[bits >> 12 & 0x3F]);
        if (this._usesPadding) {
            sb2.append(outputBytes == 2 ? this._base64ToAsciiC[bits >> 6 & 0x3F] : this._paddingChar);
            sb2.append(this._paddingChar);
        } else if (outputBytes == 2) {
            sb2.append(this._base64ToAsciiC[bits >> 6 & 0x3F]);
        }
    }
    ...
    public int encodeBase64Partial(int bits, int outputBytes, byte[] buffer, int outPtr) {
        ...
        if (this._usesPadding) {
            byte pb2 = (byte)this._paddingChar;
            buffer[outPtr++] = outputBytes == 2 ? this._base64ToAsciiB[bits >> 6 & 0x3F] : pb2;
            buffer[outPtr++] = pb2;
        } else if (outputBytes == 2) {
    ...
    public String encode(byte[] input, boolean addQuotes) {
        ...
        StringBuilder sb2 = new StringBuilder(inputEnd + (inputEnd >> 2) + (inputEnd >> 3));
        if (addQuotes) {
            sb2.append('\"');
        }
        ...
        while (inputPtr <= safeInputEnd) {
            ...
            this.encodeBase64Chunk(sb2, b24);
        ...
        if (inputLeft > 0) {
            ...
            this.encodeBase64Partial(sb2, b24, inputLeft);
        }
        if (addQuotes) {
            sb2.append('\"');
        }
    ...
    public byte[] decode(String input) throws IllegalArgumentException {
        ByteArrayBuilder b2 = new ByteArrayBuilder();
        this.decode(input, b2);
