...
Serializable {
    ...
    public JsonFactory(JsonFactoryBuilder b2) {
        this._objectCodec = null;
        this._factoryFeatures = b2._factoryFeatures;
        this._parserFeatures = b2._streamReadFeatures;
        this._generatorFeatures = b2._streamWriteFeatures;
        this._inputDecorator = b2._inputDecorator;
        this._outputDecorator = b2._outputDecorator;
        this._characterEscapes = b2._characterEscapes;
        this._rootValueSeparator = b2._rootValueSeparator;
        this._maximumNonEscapedChar = b2._maximumNonEscapedChar;
        this._quoteChar = b2._quoteChar;
    }

    protected JsonFactory(TSFBuilder<?, ?> b2, boolean bogus) {
        this._objectCodec = null;
        this._factoryFeatures = b2._factoryFeatures;
        this._parserFeatures = b2._streamReadFeatures;
        this._generatorFeatures = b2._streamWriteFeatures;
    ...
    public MatchStrength hasFormat(InputAccessor acc2) throws IOException {
        if (this.getClass() == JsonFactory.class) {
            return this.hasJSONFormat(acc2);
        }
        return null;
    }
    ...
    protected MatchStrength hasJSONFormat(InputAccessor acc2) throws IOException {
        return ByteSourceJsonBootstrapper.hasJSONFormat(acc2);
    }
    ...
    @Deprecated
    public final JsonFactory configure(Feature f2, boolean state) {
        return state ? this.enable(f2) : this.disable(f2);
    }

    @Deprecated
    public JsonFactory enable(Feature f2) {
        this._factoryFeatures |= f2.getMask();
        return this;
    }

    @Deprecated
    public JsonFactory disable(Feature f2) {
        this._factoryFeatures &= ~f2.getMask();
        return this;
    }

    public final boolean isEnabled(Feature f2) {
        return (this._factoryFeatures & f2.getMask()) != 0;
    }
    ...
    public final JsonFactory configure(JsonParser.Feature f2, boolean state) {
        return state ? this.enable(f2) : this.disable(f2);
    }

    public JsonFactory enable(JsonParser.Feature f2) {
        this._parserFeatures |= f2.getMask();
        return this;
    }

    public JsonFactory disable(JsonParser.Feature f2) {
        this._parserFeatures &= ~f2.getMask();
        return this;
    }

    @Override
    public final boolean isEnabled(JsonParser.Feature f2) {
        return (this._parserFeatures & f2.getMask()) != 0;
    }

    public final boolean isEnabled(StreamReadFeature f2) {
        return (this._parserFeatures & f2.mappedFeature().getMask()) != 0;
    }
    ...
    @Deprecated
    public JsonFactory setInputDecorator(InputDecorator d2) {
        this._inputDecorator = d2;
        return this;
    }

    public final JsonFactory configure(JsonGenerator.Feature f2, boolean state) {
        return state ? this.enable(f2) : this.disable(f2);
    }

    public JsonFactory enable(JsonGenerator.Feature f2) {
        this._generatorFeatures |= f2.getMask();
        return this;
    }

    public JsonFactory disable(JsonGenerator.Feature f2) {
        this._generatorFeatures &= ~f2.getMask();
        return this;
    }

    @Override
    public final boolean isEnabled(JsonGenerator.Feature f2) {
        return (this._generatorFeatures & f2.getMask()) != 0;
    }

    public final boolean isEnabled(StreamWriteFeature f2) {
        return (this._generatorFeatures & f2.mappedFeature().getMask()) != 0;
    }
    ...
    @Deprecated
    public JsonFactory setOutputDecorator(OutputDecorator d2) {
        this._outputDecorator = d2;
        return this;
    }
    ...
    @Override
    public JsonParser createParser(File f2) throws IOException, JsonParseException {
        IOContext ctxt = this._createContext(f2, true);
        FileInputStream in2 = new FileInputStream(f2);
        return this._createParser(this._decorate(in2, ctxt), ctxt);
    }

    @Override
    public JsonParser createParser(URL url) throws IOException, JsonParseException {
        IOContext ctxt = this._createContext(url, true);
        InputStream in2 = this._optimizedStreamFromURL(url);
        return this._createParser(this._decorate(in2, ctxt), ctxt);
    }

    @Override
    public JsonParser createParser(InputStream in2) throws IOException, JsonParseException {
        IOContext ctxt = this._createContext(in2, false);
        return this._createParser(this._decorate(in2, ctxt), ctxt);
    }
    ...
    public JsonParser createParser(byte[] data) throws IOException, JsonParseException {
        ...
        if (this._inputDecorator != null && (in2 = this._inputDecorator.decorate(ctxt, data, 0, data.length)) != null) {
            return this._createParser(in2, ctxt);
        }
    ...
    public JsonParser createParser(byte[] data, int offset, int len) throws IOException, JsonParseException {
        InputStream in2;
        IOContext ctxt = this._createContext(data, true);
        if (this._inputDecorator != null && (in2 = this._inputDecorator.decorate(ctxt, data, offset, len)) != null) {
            return this._createParser(in2, ctxt);
        }
    ...
    @Override
    public JsonParser createParser(DataInput in2) throws IOException {
        IOContext ctxt = this._createContext(in2, false);
        return this._createParser(this._decorate(in2, ctxt), ctxt);
    }
    ...
    @Deprecated
    public JsonParser createJsonParser(File f2) throws IOException, JsonParseException {
        return this.createParser(f2);
    }
    ...
    @Deprecated
    public JsonParser createJsonParser(InputStream in2) throws IOException, JsonParseException {
        return this.createParser(in2);
    }
    ...
    protected JsonParser _createParser(InputStream in2, IOContext ctxt) throws IOException {
        return new ByteSourceJsonBootstrapper(ctxt, in2).constructParser(this._parserFeatures, this._objectCodec, this._byteSymbolCanonicalizer, this._rootCharSymbols, this._factoryFeatures);
    }
    ...
    protected final InputStream _decorate(InputStream in2, IOContext ctxt) throws IOException {
        InputStream in22;
        if (this._inputDecorator != null && (in22 = this._inputDecorator.decorate(ctxt, in2)) != null) {
            return in22;
        }
        return in2;
    }

    protected final Reader _decorate(Reader in2, IOContext ctxt) throws IOException {
        Reader in22;
        if (this._inputDecorator != null && (in22 = this._inputDecorator.decorate(ctxt, in2)) != null) {
            return in22;
        }
    ...
    protected final DataInput _decorate(DataInput in2, IOContext ctxt) throws IOException {
        DataInput in22;
        if (this._inputDecorator != null && (in22 = this._inputDecorator.decorate(ctxt, in2)) != null) {
            return in22;
        }
