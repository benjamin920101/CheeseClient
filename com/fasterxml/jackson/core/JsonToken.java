...
public enum JsonToken {
    ...
    private JsonToken(String token, int id2) {
        if (token == null) {
        ...
        this._id = id2;
        this._isBoolean = id2 == 10 || id2 == 9;
        this._isNumber = id2 == 7 || id2 == 8;
        this._isStructStart = id2 == 1 || id2 == 3;
        this._isStructEnd = id2 == 2 || id2 == 4;
        this._isScalar = !this._isStructStart && !this._isStructEnd && id2 != 5 && id2 != -1;
    }
