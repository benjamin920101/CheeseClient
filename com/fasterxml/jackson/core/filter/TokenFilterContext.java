...
extends JsonStreamContext {
    ...
    public TokenFilter checkValue(TokenFilter filter) {
        ...
        int ix2 = ++this._index;
        if (this._type == 1) {
            return filter.includeElement(ix2);
        }
        return filter.includeRootValue(ix2);
    }
    ...
    public TokenFilterContext findChildOf(TokenFilterContext parent) {
        ...
        while (curr != null) {
            TokenFilterContext p2 = curr._parent;
            if (p2 == parent) {
                return curr;
            }
            curr = p2;
    ...
    protected void appendDesc(StringBuilder sb2) {
        ...
        if (this._type == 2) {
            ...
            sb2.append('[');
            sb2.append(this.getCurrentIndex());
            sb2.append(']');
        } else {
            sb2.append("/");
        }
