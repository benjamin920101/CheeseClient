...
lbl28:
    ...
    public void write(int c2) throws IOException {
        ...
        if (c2 < 128) {
            this._outBuffer[this._outPtr++] = (byte)c2;
        } else {
            int ptr = this._outPtr;
            if (c2 < 2048) {
                this._outBuffer[ptr++] = (byte)(0xC0 | c2 >> 6);
                this._outBuffer[ptr++] = (byte)(0x80 | c2 & 0x3F);
            } else if (c2 <= 65535) {
                this._outBuffer[ptr++] = (byte)(0xE0 | c2 >> 12);
                this._outBuffer[ptr++] = (byte)(0x80 | c2 >> 6 & 0x3F);
                this._outBuffer[ptr++] = (byte)(0x80 | c2 & 0x3F);
            } else {
                if (c2 > 0x10FFFF) {
                    UTF8Writer.illegalSurrogate(c2);
                }
                this._outBuffer[ptr++] = (byte)(0xF0 | c2 >> 18);
                this._outBuffer[ptr++] = (byte)(0x80 | c2 >> 12 & 0x3F);
                this._outBuffer[ptr++] = (byte)(0x80 | c2 >> 6 & 0x3F);
                this._outBuffer[ptr++] = (byte)(0x80 | c2 & 0x3F);
            }
            this._outPtr = ptr;
