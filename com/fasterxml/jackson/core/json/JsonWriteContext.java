...
extends JsonStreamContext {
    ...
    public static JsonWriteContext createRootContext(DupDetector dd2) {
        return new JsonWriteContext(0, null, dd2);
    }
    ...
    private final void _checkDup(DupDetector dd2, String name) throws JsonProcessingException {
        if (dd2.isDup(name)) {
            Object src = dd2.getSource();
