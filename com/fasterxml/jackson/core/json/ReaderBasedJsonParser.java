...
extends ParserBase {
    ...
    public ReaderBasedJsonParser(IOContext ctxt, int features, Reader r2, ObjectCodec codec, CharsToNameCanonicalizer st2, char[] inputBuffer, int start, int end, boolean bufferRecyclable) {
        super(ctxt, features);
        this._reader = r2;
        ...
        this._symbols = st2;
        this._hashSeed = st2.hashSeed();
        this._bufferRecyclable = bufferRecyclable;
    }

    public ReaderBasedJsonParser(IOContext ctxt, int features, Reader r2, ObjectCodec codec, CharsToNameCanonicalizer st2) {
        super(ctxt, features);
        this._reader = r2;
    ...
    private final JsonToken _nextTokenNotInObject(int i2) throws IOException {
        ...
        switch (i2) {
            ...
            case 44: 
            case 93: {
                if ((this._features & FEAT_MASK_ALLOW_MISSING) == 0) break;
                --this._inputPtr;
                this._currToken = JsonToken.VALUE_NULL;
                return this._currToken;
            }
    ...
    private final JsonToken _parseNumber2(boolean neg, int startPtr) throws IOException {
        ...
        int intLen = 0;
        char c3 = c2 = this._inputPtr < this._inputEnd ? this._inputBuffer[this._inputPtr++] : this.getNextChar("No digit following minus sign", JsonToken.VALUE_NUMBER_INT);
        if (c2 == '0') {
        ...
        if (intLen == 0) {
            return this._handleInvalidNumberStart(c2, neg);
        }
        int fractLen = 0;
        if (c2 == '.') {
            if (outPtr >= outBuf.length) {
    ...
    private String _parseName2(int startPtr, int hash, int endChar) throws IOException {
        ...
        while (true) {
            ...
            if ((i2 = (c2 = this._inputBuffer[this._inputPtr++])) <= '\\') {
                if (i2 == '\\') {
    ...
    private String _handleOddName2(int startPtr, int hash, int[] codes) throws IOException {
        ...
        int outPtr = this._textBuffer.getCurrentSegmentSize();
        int maxCode = codes.length;
        while ((this._inputPtr < this._inputEnd || this._loadMore()) && !((i2 = (c2 = this._inputBuffer[this._inputPtr])) < maxCode ? codes[i2] != 0 : !Character.isJavaIdentifierPart(c2))) {
            ++this._inputPtr;
            hash = hash * 33 + i2;
            outBuf[outPtr++] = c2;
            if (outPtr < outBuf.length) continue;
    ...
    protected void _finishString2() throws IOException {
        ...
        while (true) {
            ...
            if ((i2 = (c2 = this._inputBuffer[this._inputPtr++])) < maxCode && codes[i2] != 0) {
                if (i2 == '\"') break;
                if (i2 == '\\') {
                    c2 = this._decodeEscaped();
                } else if (i2 < ' ') {
    ...
    private final void _matchTrue() throws IOException {
        ...
        char[] b2;
        int ptr = this._inputPtr;
        if (ptr + 3 < this._inputEnd && (b2 = this._inputBuffer)[ptr] == 'r' && b2[++ptr] == 'u' && b2[++ptr] == 'e' && ((c2 = b2[++ptr]) < '0' || c2 == ']' || c2 == '}')) {
            this._inputPtr = ptr;
            return;
        }
        this._matchToken("true", 1);
    ...
    private final void _matchFalse() throws IOException {
        ...
        char[] b2;
        int ptr = this._inputPtr;
        if (ptr + 4 < this._inputEnd && (b2 = this._inputBuffer)[ptr] == 'a' && b2[++ptr] == 'l' && b2[++ptr] == 's' && b2[++ptr] == 'e' && ((c2 = b2[++ptr]) < '0' || c2 == ']' || c2 == '}')) {
            this._inputPtr = ptr;
            return;
        }
        this._matchToken("false", 1);
    ...
    private final void _matchNull() throws IOException {
        ...
        char[] b2;
        int ptr = this._inputPtr;
        if (ptr + 3 < this._inputEnd && (b2 = this._inputBuffer)[ptr] == 'u' && b2[++ptr] == 'l' && b2[++ptr] == 'l' && ((c2 = b2[++ptr]) < '0' || c2 == ']' || c2 == '}')) {
            this._inputPtr = ptr;
            return;
        }
        this._matchToken("null", 1);
    ...
    private final void _checkMatchEnd(String matchStr, int i2, int c2) throws IOException {
        char ch = (char)c2;
