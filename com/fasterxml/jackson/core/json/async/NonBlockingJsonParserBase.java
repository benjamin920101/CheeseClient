...
extends ParserBase {
    ...
    protected final JsonToken _closeArrayScope() throws IOException {
        ...
        int st2 = ctxt.inObject() ? 3 : (ctxt.inArray() ? 6 : 1);
        this._majorState = st2;
        this._majorStateAfterValue = st2;
    ...
    protected static final int _padLastQuad(int q2, int bytes) {
    ...
    protected final JsonToken _valueComplete(JsonToken t2) throws IOException {
    ...
    protected final JsonToken _valueCompleteInt(int value, String asText) throws IOException {
        ...
        this._majorState = this._majorStateAfterValue;
        this._currToken = t2 = JsonToken.VALUE_NUMBER_INT;
        return t2;
    }
