...
extends JsonGenerator {
    ...
    public JsonGeneratorDelegate(JsonGenerator d2) {
        this(d2, true);
    }

    public JsonGeneratorDelegate(JsonGenerator d2, boolean delegateCopyMethods) {
        this.delegate = d2;
    ...
    public JsonGenerator setPrettyPrinter(PrettyPrinter pp2) {
        this.delegate.setPrettyPrinter(pp2);
        return this;
    }
    ...
    public void writeFieldId(long id2) throws IOException {
        this.delegate.writeFieldId(id2);
    }
