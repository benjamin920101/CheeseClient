...
class ThreadLocalBufferManager {
    ...
    public SoftReference<BufferRecycler> wrapAndTrack(BufferRecycler br2) {
        SoftReference<BufferRecycler> newRef = new SoftReference<BufferRecycler>(br2, this._refQueue);
