...
extends Named {
    ...
    Serializable {
        ...
        public JsonFormat.Value findFormatOverrides(AnnotationIntrospector intr) {
            JsonFormat.Value v2;
            if (this._member != null && intr != null && (v2 = intr.findFormat(this._member)) != null) {
                return v2;
            }
            return EMPTY_FORMAT;
        }
        ...
        public JsonFormat.Value findPropertyFormat(MapperConfig<?> config, Class<?> baseType) {
            ...
            JsonFormat.Value v2 = intr.findFormat(this._member);
            if (v2 == null) {
                return v0;
            }
        ...
        public JsonInclude.Value findPropertyInclusion(MapperConfig<?> config, Class<?> baseType) {
            ...
            JsonInclude.Value v2 = intr.findPropertyInclusion(this._member);
            if (v2 == null) {
                return v0;
            }
            return v0.withOverrides(v2);
