...
implements Serializable {
    ...
    private DeserializationConfig(DeserializationConfig src, JsonNodeFactory f2) {
        super(src);
        this._deserFeatures = src._deserFeatures;
        this._problemHandlers = src._problemHandlers;
        this._nodeFactory = f2;
        this._parserFeatures = src._parserFeatures;
        this._parserFeaturesToChange = src._parserFeaturesToChange;
        this._formatReadFeatures = src._formatReadFeatures;
        this._formatReadFeaturesToChange = src._formatReadFeaturesToChange;
    ...
    private DeserializationConfig _withJsonReadFeatures(FormatFeature ... features) {
        ...
        for (FormatFeature f2 : features) {
            ...
            newSet |= mask;
            newMask |= mask;
            if (!(f2 instanceof JsonReadFeature) || (oldF = ((JsonReadFeature)f2).mappedFeature()) == null) continue;
    ...
    public DeserializationConfig with(JsonNodeFactory f2) {
        if (this._nodeFactory == f2) {
            return this;
        }
        return new DeserializationConfig(this, f2);
    }
    ...
    public final boolean isEnabled(DeserializationFeature f2) {
        return (this._deserFeatures & f2.getMask()) != 0;
    }

    public final boolean isEnabled(JsonParser.Feature f2, JsonFactory factory) {
        int mask = f2.getMask();
    ...
    public TypeDeserializer findTypeDeserializer(JavaType baseType) throws JsonMappingException {
        ...
        TypeResolverBuilder<?> b2 = this.getAnnotationIntrospector().findTypeResolver(this, ac2, baseType);
        Collection<NamedType> subtypes = null;
        if (b2 == null) {
            b2 = this.getDefaultTyper(baseType);
            if (b2 == null) {
                return null;
            }
        } else {
        ...
        return b2.buildTypeDeserializer(this, baseType, subtypes);
    }
}
