...
implements Serializable {
    ...
    protected DeserializationContext(DeserializerFactory df2, DeserializerCache cache) {
        this._factory = Objects.requireNonNull(df2, "Cannot pass null DeserializerFactory");
        if (cache == null) {
    ...
    public Date parseDate(String dateStr) throws IllegalArgumentException {
        try {
            ...
            throw new IllegalArgumentException(String.format("Failed to parse Date value '%s': %s", dateStr, ClassUtil.exceptionMessage(e2)));
        }
    }

    public Calendar constructCalendar(Date d2) {
    ...
    public JsonNode readTree(JsonParser p2) throws IOException {
        ...
        return (JsonNode)this.findRootValueDeserializer(this._config.constructType(JsonNode.class)).deserialize(p2, this);
    }
    ...
    public Object handleWeirdNativeValue(JavaType targetType, Object badValue, JsonParser p2) throws IOException {
        ...
        for (LinkedNode<DeserializationProblemHandler> h2 = this._config.getProblemHandlers(); h2 != null; h2 = h2.next()) {
            ...
            throw JsonMappingException.from(p2, this._format("DeserializationProblemHandler.handleWeirdNativeValue() for type %s returned value of type %s", ClassUtil.getClassDescription(targetType), ClassUtil.getClassDescription(goodValue)));
        }
    ...
    public Object handleUnexpectedToken(Class<?> instClass, JsonParser p2) throws IOException {
        return this.handleUnexpectedToken(this.constructType(instClass), p2.getCurrentToken(), p2, null, new Object[0]);
    }
    ...
    public Object handleUnexpectedToken(Class<?> instClass, JsonToken t2, JsonParser p2, String msg, Object ... msgArgs) throws IOException {
        return this.handleUnexpectedToken(this.constructType(instClass), t2, p2, msg, msgArgs);
    }

    public Object handleUnexpectedToken(JavaType targetType, JsonParser p2) throws IOException {
        return this.handleUnexpectedToken(targetType, p2.getCurrentToken(), p2, null, new Object[0]);
    }

    public Object handleUnexpectedToken(JavaType targetType, JsonToken t2, JsonParser p2, String msg, Object ... msgArgs) throws IOException {
        msg = this._format(msg, msgArgs);
        for (LinkedNode<DeserializationProblemHandler> h2 = this._config.getProblemHandlers(); h2 != null; h2 = h2.next()) {
            Object instance = h2.value().handleUnexpectedToken(this, targetType, t2, p2, msg);
            if (instance == DeserializationProblemHandler.NOT_HANDLED) continue;
        ...
        if (msg == null) {
            msg = t2 == null ? String.format("Unexpected end-of-input when binding data into %s", ClassUtil.getTypeDescription(targetType)) : String.format("Cannot deserialize instance of %s out of %s token", new Object[]{ClassUtil.getTypeDescription(targetType), t2});
        }
        this.reportInputMismatch(targetType, msg, new Object[0]);
        return null;
    }

    public JavaType handleUnknownTypeId(JavaType baseType, String id2, TypeIdResolver idResolver, String extraDesc) throws IOException {
        for (LinkedNode<DeserializationProblemHandler> h2 = this._config.getProblemHandlers(); h2 != null; h2 = h2.next()) {
            JavaType type = h2.value().handleUnknownTypeId(this, baseType, id2, idResolver, extraDesc);
            ...
            throw this.invalidTypeIdException(baseType, id2, "problem handler tried to resolve into non-subtype: " + ClassUtil.getTypeDescription(type));
        }
        if (!this.isEnabled(DeserializationFeature.FAIL_ON_INVALID_SUBTYPE)) {
            return null;
        }
        throw this.invalidTypeIdException(baseType, id2, extraDesc);
    }
    ...
    public <T> T reportInputMismatch(BeanProperty prop, String msg, Object ... msgArgs) throws JsonMappingException {
        ...
        MismatchedInputException e2 = MismatchedInputException.from(this.getParser(), type, msg);
        if (prop != null && (member = prop.getMember()) != null) {
            e2.prependPath(member.getDeclaringClass(), prop.getName());
        }
        throw e2;
    }
    ...
    public <T> T reportPropertyInputMismatch(Class<?> targetType, String propertyName, String msg, Object ... msgArgs) throws JsonMappingException {
        msg = this._format(msg, msgArgs);
        MismatchedInputException e2 = MismatchedInputException.from(this.getParser(), targetType, msg);
        if (propertyName != null) {
            e2.prependPath(targetType, propertyName);
        }
        throw e2;
    }
    ...
    @Deprecated
    public JsonMappingException unknownTypeException(JavaType type, String id2, String extraDesc) {
        String msg = String.format("Could not resolve type id '%s' into a subtype of %s", id2, ClassUtil.getTypeDescription(type));
