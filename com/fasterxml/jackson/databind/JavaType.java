...
Type {
    ...
    public JavaType withHandlersFrom(JavaType src) {
        JavaType type = this;
        Object h2 = src.getTypeHandler();
        if (h2 != this._typeHandler) {
            type = type.withTypeHandler(h2);
        }
        if ((h2 = src.getValueHandler()) != this._valueHandler) {
    ...
    public JavaType containedTypeOrUnknown(int index) {
        JavaType t2 = this.containedType(index);
        return t2 == null ? TypeFactory.unknownType() : t2;
    }
