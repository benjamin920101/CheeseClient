...
implements NullValueProvider {
    ...
    public Object deserializeWithType(JsonParser p2, DeserializationContext ctxt, TypeDeserializer typeDeserializer, T intoValue) throws IOException {
        ctxt.handleBadMerge(this);
        return this.deserializeWithType(p2, ctxt, typeDeserializer);
    }
