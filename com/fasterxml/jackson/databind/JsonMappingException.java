...
extends JsonProcessingException {
    ...
    public static JsonMappingException from(JsonParser p2, String msg) {
        return new JsonMappingException(p2, msg);
    }

    public static JsonMappingException from(JsonParser p2, String msg, Throwable problem) {
        return new JsonMappingException((Closeable)p2, msg, problem);
    }

    public static JsonMappingException from(JsonGenerator g2, String msg) {
        return new JsonMappingException((Closeable)g2, msg, (Throwable)null);
    }

    public static JsonMappingException from(JsonGenerator g2, String msg, Throwable problem) {
        return new JsonMappingException((Closeable)g2, msg, problem);
    }
    ...
    public static JsonMappingException from(DeserializationContext ctxt, String msg, Throwable t2) {
        return new JsonMappingException((Closeable)ctxt.getParser(), msg, t2);
    }
    ...
    public void prependPath(Reference r2) {
        if (this._path == null) {
            this._path = new LinkedList();
        }
        if (this._path.size() < 1000) {
            this._path.addFirst(r2);
        }
    }
    ...
    protected String _buildMessage() {
        ...
        StringBuilder sb2 = msg == null ? new StringBuilder() : new StringBuilder(msg);
        sb2.append(" (through reference chain: ");
        sb2 = this.getPathReference(sb2);
        sb2.append(')');
        return sb2.toString();
    }
    ...
    protected void _appendPathDesc(StringBuilder sb2) {
        ...
        while (it2.hasNext()) {
            sb2.append(((Reference)it2.next()).toString());
    ...
    implements Serializable {
        ...
        void setFieldName(String n2) {
            this._fieldName = n2;
        }

        void setIndex(int ix2) {
            this._index = ix2;
        }

        void setDescription(String d2) {
            this._desc = d2;
        }
