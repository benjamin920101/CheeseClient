...
implements Serializable {
    ...
    public PropertyMetadata withRequired(Boolean b2) {
        if (b2 == null ? this._required == null : b2.equals(this._required)) {
            return this;
        }
        return new PropertyMetadata(b2, this._description, this._index, this._defaultValue, this._mergeInfo, this._valueNulls, this._contentNulls);
    }
