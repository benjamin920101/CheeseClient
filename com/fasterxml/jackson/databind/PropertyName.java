...
implements Serializable {
    ...
    public static PropertyName construct(String simpleName, String ns2) {
        if (simpleName == null) {
            simpleName = "";
        }
        if (ns2 == null && simpleName.length() == 0) {
            return USE_DEFAULT;
        }
        return new PropertyName(InternCache.instance.intern(simpleName), ns2);
    }
    ...
    public PropertyName withNamespace(String ns2) {
        if (ns2 == null ? this._namespace == null : ns2.equals(this._namespace)) {
            return this;
        }
        return new PropertyName(this._simpleName, ns2);
    }
    ...
    public boolean equals(Object o2) {
        ...
        PropertyName other = (PropertyName)o2;
