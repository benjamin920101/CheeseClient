...
extends DatabindContext {
    ...
    protected SerializerProvider(SerializerProvider src, SerializationConfig config, SerializerFactory f2) {
    ...
    public <T> T reportBadDefinition(JavaType type, String msg, Throwable cause) throws JsonMappingException {
        InvalidDefinitionException e2 = InvalidDefinitionException.from(this.getGenerator(), msg, type);
        e2.initCause(cause);
        throw e2;
    }

    public <T> T reportBadDefinition(Class<?> raw, String msg, Throwable cause) throws JsonMappingException {
        InvalidDefinitionException e2 = InvalidDefinitionException.from(this.getGenerator(), msg, this.constructType(raw));
        e2.initCause(cause);
        throw e2;
    }

    public void reportMappingProblem(Throwable t2, String message, Object ... msgArgs) throws JsonMappingException {
        message = this._format(message, msgArgs);
        throw JsonMappingException.from(this.getGenerator(), message, t2);
    }
    ...
    @Deprecated
    protected JsonMappingException mappingException(Throwable t2, String message, Object ... msgArgs) {
        return JsonMappingException.from(this.getGenerator(), this._format(message, msgArgs), t2);
    }
