...
Serializable {
    ...
    public final boolean isEnabled(MapperFeature f2) {
        return (this._mapperFeatures & f2.getMask()) != 0;
    }
    ...
    public TypeResolverBuilder<?> typeResolverBuilderInstance(Annotated annotated, Class<? extends TypeResolverBuilder<?>> builderClass) {
        ...
        HandlerInstantiator hi2 = this.getHandlerInstantiator();
        if (hi2 != null && (builder = hi2.typeResolverBuilderInstance(this, annotated, builderClass)) != null) {
            return builder;
        }
    ...
    public TypeIdResolver typeIdResolverInstance(Annotated annotated, Class<? extends TypeIdResolver> resolverClass) {
        ...
        HandlerInstantiator hi2 = this.getHandlerInstantiator();
        if (hi2 != null && (builder = hi2.typeIdResolverInstance(this, annotated, resolverClass)) != null) {
            return builder;
        }
