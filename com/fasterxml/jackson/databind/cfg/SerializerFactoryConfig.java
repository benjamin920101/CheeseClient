...
implements Serializable {
    ...
    public SerializerFactoryConfig withAdditionalSerializers(Serializers additional) {
        ...
        Serializers[] all2 = ArrayBuilders.insertInListNoDup(this._additionalSerializers, additional);
        return new SerializerFactoryConfig(all2, this._additionalKeySerializers, this._modifiers);
    }
    ...
    public SerializerFactoryConfig withAdditionalKeySerializers(Serializers additional) {
        ...
        Serializers[] all2 = ArrayBuilders.insertInListNoDup(this._additionalKeySerializers, additional);
        return new SerializerFactoryConfig(this._additionalSerializers, all2, this._modifiers);
    }
