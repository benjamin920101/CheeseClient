...
Serializable {
    ...
    public Object deserializeWithType(JsonParser p2, DeserializationContext ctxt, TypeDeserializer typeDeserializer) throws IOException {
        Object result;
        JsonToken t2;
        if (this._objectIdReader != null && (t2 = p2.currentToken()) != null) {
            if (t2.isScalarValue()) {
    ...
    protected Object _deserializeFromObjectId(JsonParser p2, DeserializationContext ctxt) throws IOException {
        ...
        if (pojo == null) {
            throw new UnresolvedForwardReference(p2, "Could not resolve Object Id [" + id2 + "] -- unresolved forward-reference?", p2.getCurrentLocation(), roid);
        }
        return pojo;
    }
}
