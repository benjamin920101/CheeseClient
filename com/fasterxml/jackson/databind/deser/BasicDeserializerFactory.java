...
implements Serializable {
    ...
    protected Map<AnnotatedWithParams, BeanPropertyDefinition[]> _findCreatorsFromProperties(DeserializationContext ctxt, BeanDescription beanDesc) throws JsonMappingException {
        ...
        for (BeanPropertyDefinition propDef : beanDesc.findProperties()) {
            Iterator<AnnotatedParameter> it2 = propDef.getConstructorParameters();
            while (it2.hasNext()) {
                AnnotatedParameter param = it2.next();
    ...
    public ValueInstantiator _valueInstantiatorInstance(DeserializationConfig config, Annotated annotated, Object instDef) throws JsonMappingException {
        ...
        if (hi2 != null && (inst = hi2.valueInstantiatorInstance(config, annotated, instClass)) != null) {
            return inst;
        }
    ...
    protected void _addDeserializerConstructors(DeserializationContext ctxt, BeanDescription beanDesc, VisibilityChecker<?> vchecker, AnnotationIntrospector intr, CreatorCollector creators, Map<AnnotatedWithParams, BeanPropertyDefinition[]> creatorParams) throws JsonMappingException {
        ...
        for (CreatorCandidate candidate : nonAnnotated) {
            ...
            for (int i2 = 0; i2 < argCount; ++i2) {
                ...
                BeanPropertyDefinition propDef = candidate.propertyDef(i2);
    ...
    protected void _addExplicitDelegatingCreator(DeserializationContext ctxt, BeanDescription beanDesc, CreatorCollector creators, CreatorCandidate candidate) throws JsonMappingException {
        ...
        SettableBeanProperty[] properties = new SettableBeanProperty[argCount];
        for (int i2 = 0; i2 < argCount; ++i2) {
            AnnotatedParameter param = candidate.parameter(i2);
            JacksonInject.Value injectId = candidate.injection(i2);
            if (injectId != null) {
                properties[i2] = this.constructCreatorProperty(ctxt, beanDesc, null, i2, param, injectId);
                continue;
            }
            if (ix2 < 0) {
                ix2 = i2;
            ...
            ctxt.reportBadTypeDefinition(beanDesc, "More than one argument (#%d and #%d) left as delegating for Creator %s: only one allowed", ix2, i2, candidate);
        }
        if (ix2 < 0) {
        ...
        creators.addDelegatingCreator(candidate.creator(), true, properties, ix2);
    }
    ...
    protected void _addExplicitPropertyCreator(DeserializationContext ctxt, BeanDescription beanDesc, CreatorCollector creators, CreatorCandidate candidate) throws JsonMappingException {
        ...
        for (int i2 = 0; i2 < paramCount; ++i2) {
            JacksonInject.Value injectId = candidate.injection(i2);
            AnnotatedParameter param = candidate.parameter(i2);
            PropertyName name = candidate.paramName(i2);
            if (name == null) {
                NameTransformer unwrapper = ctxt.getAnnotationIntrospector().findUnwrappingNameTransformer(param);
                if (unwrapper != null) {
                    this._reportUnwrappedCreatorProperty(ctxt, beanDesc, param);
                }
                if ((name = candidate.findImplicitParamName(i2)) == null && injectId == null) {
                    ctxt.reportBadTypeDefinition(beanDesc, "Argument #%d has no property name, is not Injectable: can not use as Creator %s", i2, candidate);
                }
            }
            properties[i2] = this.constructCreatorProperty(ctxt, beanDesc, name, i2, param, injectId);
        }
    ...
    protected void _addExplicitAnyCreator(DeserializationContext ctxt, BeanDescription beanDesc, CreatorCollector creators, CreatorCandidate candidate) throws JsonMappingException {
        ...
        BeanPropertyDefinition paramDef = candidate.propertyDef(0);
        boolean bl2 = useProps = paramName != null || injectId != null;
        if (!useProps && paramDef != null) {
            paramName = candidate.paramName(0);
            boolean bl3 = useProps = paramName != null && paramDef.couldSerialize();
        }
        if (useProps) {
    ...
    protected SettableBeanProperty constructCreatorProperty(DeserializationContext ctxt, BeanDescription beanDesc, PropertyName name, int index, AnnotatedParameter param, JacksonInject.Value injectable) throws JsonMappingException {
        ...
        if (intr == null) {
            ...
            Boolean b2 = intr.hasRequiredMarker(param);
            String desc = intr.findPropertyDescription(param);
            Integer idx = intr.findPropertyIndex(param);
            String def = intr.findPropertyDefaultValue(param);
            metadata = PropertyMetadata.construct(b2, desc, idx, def);
        }
    ...
    protected PropertyMetadata _getSetterInfo(DeserializationContext ctxt, BeanProperty prop, PropertyMetadata metadata) {
        ...
        if (prim != null) {
            ...
            if ((needMerge || valueNulls == null || contentNulls == null) && (setterInfo2 = (co2 = config.getConfigOverride(prop.getType().getRawClass())).getSetterInfo()) != null) {
                if (valueNulls == null) {
        ...
        if ((deser = this._findCustomMapDeserializer(type, config, beanDesc, keyDes, contentTypeDeser, contentDeser)) == null) {
            ...
            if (deser == null) {
                ...
                if (deser == null) {
                    ...
                    MapDeserializer md2 = new MapDeserializer(type, inst, keyDes, contentDeser, contentTypeDeser);
                    ...
                    md2.setIgnorableProperties(ignored);
                    deser = md2;
                }
            }
        }
    ...
    public TypeDeserializer findTypeDeserializer(DeserializationConfig config, JavaType baseType) throws JsonMappingException {
        ...
        TypeResolverBuilder<?> b2 = ai2.findTypeResolver(config, ac2, baseType);
        Collection<NamedType> subtypes = null;
        if (b2 == null) {
            b2 = config.getDefaultTyper(baseType);
            if (b2 == null) {
                return null;
            }
        } else {
        ...
        if (b2.getDefaultImpl() == null && baseType.isAbstract() && (defaultType = this.mapAbstractType(config, baseType)) != null && !defaultType.hasRawClass(baseType.getRawClass())) {
            b2 = b2.defaultImpl(defaultType.getRawClass());
        }
        try {
            return b2.buildTypeDeserializer(config, baseType, subtypes);
        }
        catch (IllegalArgumentException e0) {
            InvalidDefinitionException e2 = InvalidDefinitionException.from((JsonParser)null, ClassUtil.exceptionMessage(e0), baseType);
            e2.initCause(e0);
            throw e2;
        }
    }
    ...
    public KeyDeserializer createKeyDeserializer(DeserializationContext ctxt, JavaType type) throws JsonMappingException {
        ...
        if (this._factoryConfig.hasKeyDeserializers()) {
            ...
            while (iterator.hasNext() && (deser = (d2 = iterator.next()).findKeyDeserializer(type, config, beanDesc)) == null) {
            }
        }
        if (deser == null) {
    ...
    public TypeDeserializer findPropertyTypeDeserializer(DeserializationConfig config, JavaType baseType, AnnotatedMember annotated) throws JsonMappingException {
        AnnotationIntrospector ai2 = config.getAnnotationIntrospector();
        TypeResolverBuilder<?> b2 = ai2.findPropertyTypeResolver(config, annotated, baseType);
        if (b2 == null) {
    ...
    public TypeDeserializer findPropertyContentTypeDeserializer(DeserializationConfig config, JavaType containerType, AnnotatedMember propertyEntity) throws JsonMappingException {
        AnnotationIntrospector ai2 = config.getAnnotationIntrospector();
        TypeResolverBuilder<?> b2 = ai2.findPropertyContentTypeResolver(config, propertyEntity, containerType);
        ...
        return b2.buildTypeDeserializer(config, contentType, subtypes);
    }
    ...
    public JsonDeserializer<?> findDefaultDeserializer(DeserializationContext ctxt, JavaType type, BeanDescription beanDesc) throws JsonMappingException {
        ...
        if (rawType == CLASS_OBJECT || rawType == CLASS_SERIALIZABLE) {
            ...
            DeserializationConfig config = ctxt.getConfig();
            if (this._factoryConfig.hasAbstractTypeResolvers()) {
                lt2 = this._findRemappedType(config, List.class);
                mt2 = this._findRemappedType(config, Map.class);
            } else {
                mt2 = null;
                lt2 = null;
            }
            return new UntypedObjectDeserializer(lt2, mt2);
        }
        ...
        if (rawType == CLASS_ITERABLE) {
            ...
            JavaType[] tps = tf2.findTypeParameters(type, CLASS_ITERABLE);
            JavaType elemType = tps == null || tps.length != 1 ? TypeFactory.unknownType() : tps[0];
            CollectionType ct2 = tf2.constructCollectionType(Collection.class, elemType);
            return this.createCollectionDeserializer(ctxt, ct2, beanDesc);
        }
        if (rawType == CLASS_MAP_ENTRY) {
            JavaType kt = type.containedTypeOrUnknown(0);
            JavaType vt2 = type.containedTypeOrUnknown(1);
            TypeDeserializer vts = (TypeDeserializer)vt2.getTypeHandler();
            if (vts == null) {
                vts = this.findTypeDeserializer(ctxt.getConfig(), vt2);
            }
            JsonDeserializer valueDeser = (JsonDeserializer)vt2.getValueHandler();
    ...
    protected JsonDeserializer<?> _findCustomTreeNodeDeserializer(Class<? extends JsonNode> type, DeserializationConfig config, BeanDescription beanDesc) throws JsonMappingException {
        for (Deserializers d2 : this._factoryConfig.deserializers()) {
            JsonDeserializer<?> deser = d2.findTreeNodeDeserializer(type, config, beanDesc);
    ...
    protected JsonDeserializer<?> _findCustomReferenceDeserializer(ReferenceType type, DeserializationConfig config, BeanDescription beanDesc, TypeDeserializer contentTypeDeserializer, JsonDeserializer<?> contentDeserializer) throws JsonMappingException {
        for (Deserializers d2 : this._factoryConfig.deserializers()) {
            JsonDeserializer<?> deser = d2.findReferenceDeserializer(type, config, beanDesc, contentTypeDeserializer, contentDeserializer);
            if (deser == null) continue;
            return deser;
        }
        return null;
    ...
    protected JsonDeserializer<Object> _findCustomBeanDeserializer(JavaType type, DeserializationConfig config, BeanDescription beanDesc) throws JsonMappingException {
        for (Deserializers d2 : this._factoryConfig.deserializers()) {
            JsonDeserializer<Object> deser = d2.findBeanDeserializer(type, config, beanDesc);
            if (deser == null) continue;
            return deser;
        }
        return null;
    ...
    protected JsonDeserializer<?> _findCustomArrayDeserializer(ArrayType type, DeserializationConfig config, BeanDescription beanDesc, TypeDeserializer elementTypeDeserializer, JsonDeserializer<?> elementDeserializer) throws JsonMappingException {
        for (Deserializers d2 : this._factoryConfig.deserializers()) {
            JsonDeserializer<?> deser = d2.findArrayDeserializer(type, config, beanDesc, elementTypeDeserializer, elementDeserializer);
            if (deser == null) continue;
            return deser;
        }
        return null;
    ...
    protected JsonDeserializer<?> _findCustomCollectionDeserializer(CollectionType type, DeserializationConfig config, BeanDescription beanDesc, TypeDeserializer elementTypeDeserializer, JsonDeserializer<?> elementDeserializer) throws JsonMappingException {
        for (Deserializers d2 : this._factoryConfig.deserializers()) {
            JsonDeserializer<?> deser = d2.findCollectionDeserializer(type, config, beanDesc, elementTypeDeserializer, elementDeserializer);
            if (deser == null) continue;
            return deser;
        }
        return null;
    ...
    protected JsonDeserializer<?> _findCustomCollectionLikeDeserializer(CollectionLikeType type, DeserializationConfig config, BeanDescription beanDesc, TypeDeserializer elementTypeDeserializer, JsonDeserializer<?> elementDeserializer) throws JsonMappingException {
        for (Deserializers d2 : this._factoryConfig.deserializers()) {
            JsonDeserializer<?> deser = d2.findCollectionLikeDeserializer(type, config, beanDesc, elementTypeDeserializer, elementDeserializer);
            if (deser == null) continue;
            return deser;
        }
        return null;
    ...
    protected JsonDeserializer<?> _findCustomEnumDeserializer(Class<?> type, DeserializationConfig config, BeanDescription beanDesc) throws JsonMappingException {
        for (Deserializers d2 : this._factoryConfig.deserializers()) {
            JsonDeserializer<?> deser = d2.findEnumDeserializer(type, config, beanDesc);
            if (deser == null) continue;
            return deser;
        }
        return null;
    ...
    protected JsonDeserializer<?> _findCustomMapDeserializer(MapType type, DeserializationConfig config, BeanDescription beanDesc, KeyDeserializer keyDeserializer, TypeDeserializer elementTypeDeserializer, JsonDeserializer<?> elementDeserializer) throws JsonMappingException {
        for (Deserializers d2 : this._factoryConfig.deserializers()) {
            JsonDeserializer<?> deser = d2.findMapDeserializer(type, config, beanDesc, keyDeserializer, elementTypeDeserializer, elementDeserializer);
            if (deser == null) continue;
            return deser;
        }
        return null;
    ...
    protected JsonDeserializer<?> _findCustomMapLikeDeserializer(MapLikeType type, DeserializationConfig config, BeanDescription beanDesc, KeyDeserializer keyDeserializer, TypeDeserializer elementTypeDeserializer, JsonDeserializer<?> elementDeserializer) throws JsonMappingException {
        for (Deserializers d2 : this._factoryConfig.deserializers()) {
            JsonDeserializer<?> deser = d2.findMapLikeDeserializer(type, config, beanDesc, keyDeserializer, elementTypeDeserializer, elementDeserializer);
            if (deser == null) continue;
            return deser;
        }
        return null;
    ...
    protected JsonDeserializer<Object> findDeserializerFromAnnotation(DeserializationContext ctxt, Annotated ann2) throws JsonMappingException {
        Object deserDef;
        AnnotationIntrospector intr = ctxt.getAnnotationIntrospector();
        if (intr != null && (deserDef = intr.findDeserializer(ann2)) != null) {
            return ctxt.deserializerInstance(ann2, deserDef);
        }
        return null;
    }

    protected KeyDeserializer findKeyDeserializerFromAnnotation(DeserializationContext ctxt, Annotated ann2) throws JsonMappingException {
        Object deserDef;
        AnnotationIntrospector intr = ctxt.getAnnotationIntrospector();
        if (intr != null && (deserDef = intr.findKeyDeserializer(ann2)) != null) {
            return ctxt.keyDeserializerInstance(ann2, deserDef);
        }
        return null;
    }

    protected JsonDeserializer<Object> findContentDeserializerFromAnnotation(DeserializationContext ctxt, Annotated ann2) throws JsonMappingException {
        Object deserDef;
        AnnotationIntrospector intr = ctxt.getAnnotationIntrospector();
        if (intr != null && (deserDef = intr.findContentDeserializer(ann2)) != null) {
            return ctxt.deserializerInstance(ann2, deserDef);
        }
        return null;
    }
    ...
    protected boolean _hasCreatorAnnotation(DeserializationContext ctxt, Annotated ann2) {
        AnnotationIntrospector intr = ctxt.getAnnotationIntrospector();
        if (intr != null) {
            JsonCreator.Mode mode = intr.findCreatorAnnotation(ctxt.getConfig(), ann2);
    ...
    @Deprecated
    protected JavaType modifyTypeByAnnotation(DeserializationContext ctxt, Annotated a2, JavaType type) throws JsonMappingException {
        AnnotationIntrospector intr = ctxt.getAnnotationIntrospector();
        if (intr == null) {
            return type;
        }
        return intr.refineDeserializationType(ctxt.getConfig(), a2, type);
    }
