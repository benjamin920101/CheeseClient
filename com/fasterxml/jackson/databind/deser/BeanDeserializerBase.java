...
Serializable {
    ...
    public void resolve(DeserializationContext ctxt) throws JsonMappingException {
        ...
        if (this._valueInstantiator.canCreateFromObjectWith()) {
            ...
            if (this._ignorableProps != null) {
                ...
                for (int i2 = 0; i2 < end; ++i2) {
                    ...
                    creatorProps[i2].markAsIgnorable();
                }
            }
        } else {
            creatorProps = null;
        ...
        while (end.hasNext()) {
            ...
            PropertyMetadata md2 = prop.getMetadata();
            prop = this._resolveMergeAndNullSettings(ctxt, prop, md2);
    ...
    private JsonDeserializer<Object> _findDelegateDeserializer(DeserializationContext ctxt, JavaType delegateType, AnnotatedWithParams delegateCreator) throws JsonMappingException {
        ...
        dd2 = (dd2 = (JsonDeserializer<Object>)delegateType.getValueHandler()) == null ? this.findDeserializer(ctxt, delegateType, property) : ctxt.handleSecondaryContextualization(dd2, property, delegateType);
        if (td != null) {
    ...
    public JsonDeserializer<?> createContextual(DeserializationContext ctxt, BeanProperty property) throws JsonMappingException {
        ...
        if (format != null) {
            ...
            if ((B2 = format.getFeature(JsonFormat.Feature.ACCEPT_CASE_INSENSITIVE_PROPERTIES)) != null && (props = (propsOrig = this._beanProperties).withCaseInsensitivity(B2)) != propsOrig) {
    ...
    protected SettableBeanProperty _resolveInnerClassValuedProperty(DeserializationContext ctxt, SettableBeanProperty prop) {
        ...
        ValueInstantiator vi2;
        JsonDeserializer<Object> deser = prop.getValueDeserializer();
        if (deser instanceof BeanDeserializerBase && !(vi2 = (bd2 = (BeanDeserializerBase)deser).getValueInstantiator()).canCreateUsingDefault() && (enclosing = ClassUtil.getOuterClass(valueClass = prop.getType().getRawClass())) != null && enclosing == this._beanType.getRawClass()) {
    ...
    public Object deserializeWithType(JsonParser p2, DeserializationContext ctxt, TypeDeserializer typeDeserializer) throws IOException {
        if (this._objectIdReader != null) {
            Object id2;
            if (p2.canReadObjectId() && (id2 = p2.getObjectId()) != null) {
                Object ob2 = typeDeserializer.deserializeTypedFromObject(p2, ctxt);
                return this._handleTypedObjectId(p2, ctxt, ob2, id2);
            }
    ...
    protected Object _handleTypedObjectId(JsonParser p2, DeserializationContext ctxt, Object pojo, Object rawId) throws IOException {
        ...
        Object id2 = idDeser.handledType() == rawId.getClass() ? rawId : this._convertObjectId(p2, ctxt, rawId, idDeser);
        ...
        if (idProp != null) {
            return idProp.setAndReturn(pojo, id2);
        }
        return pojo;
    }
    ...
    protected Object deserializeFromObjectId(JsonParser p2, DeserializationContext ctxt) throws IOException {
        Object id2 = this._objectIdReader.readObjectReference(p2, ctxt);
        ReadableObjectId roid = ctxt.findObjectId(id2, this._objectIdReader.generator, this._objectIdReader.resolver);
        Object pojo = roid.resolve();
        if (pojo == null) {
            throw new UnresolvedForwardReference(p2, "Could not resolve Object Id [" + id2 + "] (for " + this._beanType + ").", p2.getCurrentLocation(), roid);
        }
        return pojo;
    }
    ...
    protected Object deserializeFromObjectUsingNonDefault(JsonParser p2, DeserializationContext ctxt) throws IOException {
        ...
        if (ClassUtil.isNonStaticInnerClass(raw)) {
            return ctxt.handleMissingInstantiator(raw, null, p2, "non-static inner classes like this can only by instantiated using default, no-argument constructor", new Object[0]);
        }
    ...
    protected void handleUnknownVanilla(JsonParser p2, DeserializationContext ctxt, Object beanOrBuilder, String propName) throws IOException {
        if (this._ignorableProps != null && this._ignorableProps.contains(propName)) {
            this.handleIgnoredProperty(p2, ctxt, beanOrBuilder, propName);
        } else if (this._anySetter != null) {
            try {
                this._anySetter.deserializeAndSet(p2, ctxt, beanOrBuilder, propName);
            }
            catch (Exception e2) {
                this.wrapAndThrow(e2, beanOrBuilder, propName, ctxt);
            }
        } else {
            this.handleUnknownProperty(p2, ctxt, beanOrBuilder, propName);
        }
    }
