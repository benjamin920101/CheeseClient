...
implements Serializable {
    ...
    protected void _throwAsIOE(Exception e2, Object propName, Object value) throws IOException {
        ...
        Throwable t2 = ClassUtil.getRootCause(e2);
        throw new JsonMappingException(null, ClassUtil.exceptionMessage(t2), t2);
    }
    ...
    extends ReadableObjectId.Referring {
        ...
        public void handleResolvedForwardReference(Object id2, Object value) throws IOException {
            if (!this.hasId(id2)) {
                throw new IllegalArgumentException("Trying to resolve a forward reference with id [" + id2.toString() + "] that wasn't previously registered.");
            }
