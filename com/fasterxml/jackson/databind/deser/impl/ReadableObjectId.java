...
public class ReadableObjectId {
    ...
    public void bindItem(Object ob2) throws IOException {
        this._resolver.bindItem(this._key, ob2);
        this._item = ob2;
        Object id2 = this._key.key;
        if (this._referringProperties != null) {
            Iterator it2 = this._referringProperties.iterator();
            this._referringProperties = null;
            while (it2.hasNext()) {
                ((Referring)it2.next()).handleResolvedForwardReference(id2, ob2);
            }
        }
    }
    ...
    public static abstract class Referring {
        ...
        public boolean hasId(Object id2) {
            return id2.equals(this._reference.getUnresolvedId());
        }
    }
}
