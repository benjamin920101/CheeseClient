...
ResolvableDeserializer {
    ...
    public DelegatingDeserializer(JsonDeserializer<?> d2) {
        super(d2.handledType());
        this._delegatee = d2;
    }
    ...
    public JsonDeserializer<?> createContextual(DeserializationContext ctxt, BeanProperty property) throws JsonMappingException {
        JavaType vt2 = ctxt.constructType(this._delegatee.handledType());
        JsonDeserializer<?> del = ctxt.handleSecondaryContextualization(this._delegatee, property, vt2);
