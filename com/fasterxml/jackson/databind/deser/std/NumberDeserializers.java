...
public class NumberDeserializers {
    ...
    extends StdScalarDeserializer<BigDecimal> {
        ...
        @Override
        public BigDecimal deserialize(JsonParser p2, DeserializationContext ctxt) throws IOException {
            switch (p2.getCurrentTokenId()) {
                ...
                case 3: {
                    return (BigDecimal)this._deserializeFromArray(p2, ctxt);
                }
            }
            return (BigDecimal)ctxt.handleUnexpectedToken(this._valueClass, p2);
        }
    }
    ...
    extends StdScalarDeserializer<BigInteger> {
        ...
        @Override
        public BigInteger deserialize(JsonParser p2, DeserializationContext ctxt) throws IOException {
            switch (p2.getCurrentTokenId()) {
                case 7: {
                ...
                case 8: {
                    if (!ctxt.isEnabled(DeserializationFeature.ACCEPT_FLOAT_AS_INT)) {
                        this._failDoubleToIntCoercion(p2, ctxt, "java.math.BigInteger");
                    }
                    return p2.getDecimalValue().toBigInteger();
                }
                case 3: {
                    return (BigInteger)this._deserializeFromArray(p2, ctxt);
                }
                case 6: {
                    String text = p2.getText().trim();
                    if (this._isEmptyOrTextualNull(text)) {
            ...
            return (BigInteger)ctxt.handleUnexpectedToken(this._valueClass, p2);
        }
    }
    ...
    extends StdScalarDeserializer<Object> {
        ...
        public Object deserialize(JsonParser p2, DeserializationContext ctxt) throws IOException {
            switch (p2.getCurrentTokenId()) {
                ...
                case 8: {
                    if (ctxt.isEnabled(DeserializationFeature.USE_BIG_DECIMAL_FOR_FLOATS) && !p2.isNaN()) {
                        return p2.getDecimalValue();
                    }
                    return p2.getNumberValue();
                }
            ...
            return ctxt.handleUnexpectedToken(this._valueClass, p2);
        }
    ...
    extends PrimitiveOrWrapperDeserializer<Double> {
        ...
        public Double deserialize(JsonParser p2, DeserializationContext ctxt) throws IOException {
            return this._parseDouble(p2, ctxt);
        }

        @Override
        public Double deserializeWithType(JsonParser p2, DeserializationContext ctxt, TypeDeserializer typeDeserializer) throws IOException {
            return this._parseDouble(p2, ctxt);
        }
        ...
        protected final Double _parseDouble(JsonParser p2, DeserializationContext ctxt) throws IOException {
            ...
            if (t2 == JsonToken.START_ARRAY) {
                return (Double)this._deserializeFromArray(p2, ctxt);
            }
    ...
    extends PrimitiveOrWrapperDeserializer<Float> {
        ...
        public Float deserialize(JsonParser p2, DeserializationContext ctxt) throws IOException {
            return this._parseFloat(p2, ctxt);
        }

        protected final Float _parseFloat(JsonParser p2, DeserializationContext ctxt) throws IOException {
            JsonToken t2 = p2.getCurrentToken();
            if (t2 == JsonToken.VALUE_NUMBER_FLOAT || t2 == JsonToken.VALUE_NUMBER_INT) {
            ...
            if (t2 == JsonToken.START_ARRAY) {
                return (Float)this._deserializeFromArray(p2, ctxt);
            }
    ...
    extends PrimitiveOrWrapperDeserializer<Long> {
        ...
        public Long deserialize(JsonParser p2, DeserializationContext ctxt) throws IOException {
            ...
            return this._parseLong(p2, ctxt);
        }
    ...
    extends PrimitiveOrWrapperDeserializer<Integer> {
        ...
        @Override
        public Integer deserialize(JsonParser p2, DeserializationContext ctxt) throws IOException {
            if (p2.hasToken(JsonToken.VALUE_NUMBER_INT)) {
                return p2.getIntValue();
            }
            return this._parseInteger(p2, ctxt);
        }

        @Override
        public Integer deserializeWithType(JsonParser p2, DeserializationContext ctxt, TypeDeserializer typeDeserializer) throws IOException {
            if (p2.hasToken(JsonToken.VALUE_NUMBER_INT)) {
                return p2.getIntValue();
            }
            return this._parseInteger(p2, ctxt);
    ...
    extends PrimitiveOrWrapperDeserializer<Character> {
        ...
        @Override
        public Character deserialize(JsonParser p2, DeserializationContext ctxt) throws IOException {
            switch (p2.getCurrentTokenId()) {
                case 7: {
                    this._verifyNumberForScalarCoercion(ctxt, p2);
                    int value = p2.getIntValue();
                ...
                case 3: {
                    return (Character)this._deserializeFromArray(p2, ctxt);
                }
            }
            return (Character)ctxt.handleUnexpectedToken(this._valueClass, p2);
        }
    }
    ...
    extends PrimitiveOrWrapperDeserializer<Short> {
        ...
        public Short deserialize(JsonParser p2, DeserializationContext ctxt) throws IOException {
            return this._parseShort(p2, ctxt);
        }
        ...
        protected Short _parseShort(JsonParser p2, DeserializationContext ctxt) throws IOException {
            ...
            if (t2 == JsonToken.START_ARRAY) {
                return (Short)this._deserializeFromArray(p2, ctxt);
            }
    ...
    extends PrimitiveOrWrapperDeserializer<Byte> {
        ...
        public Byte deserialize(JsonParser p2, DeserializationContext ctxt) throws IOException {
            ...
            return this._parseByte(p2, ctxt);
        }
        ...
        protected Byte _parseByte(JsonParser p2, DeserializationContext ctxt) throws IOException {
            ...
            if (t2 == JsonToken.START_ARRAY) {
                return (Byte)this._deserializeFromArray(p2, ctxt);
            }
            if (t2 == JsonToken.VALUE_NUMBER_INT) {
                return p2.getByteValue();
            }
    ...
    extends PrimitiveOrWrapperDeserializer<Boolean> {
        ...
        public Boolean deserialize(JsonParser p2, DeserializationContext ctxt) throws IOException {
            ...
            return this._parseBoolean(p2, ctxt);
        }

        @Override
        public Boolean deserializeWithType(JsonParser p2, DeserializationContext ctxt, TypeDeserializer typeDeserializer) throws IOException {
            JsonToken t2 = p2.getCurrentToken();
            if (t2 == JsonToken.VALUE_TRUE) {
                return Boolean.TRUE;
            }
    ...
    extends StdScalarDeserializer<T> {
        ...
        protected PrimitiveOrWrapperDeserializer(Class<T> vc2, T nvl, T empty) {
            super(vc2);
            this._nullValue = nvl;
            this._emptyValue = empty;
            this._primitive = vc2.isPrimitive();
        }
