...
implements ContextualDeserializer {
    ...
    public ReferenceTypeDeserializer(JavaType fullType, ValueInstantiator vi2, TypeDeserializer typeDeser, JsonDeserializer<?> deser) {
        super(fullType);
        this._valueInstantiator = vi2;
    ...
    public T deserialize(JsonParser p2, DeserializationContext ctxt, T reference) throws IOException {
        Object contents;
        Boolean B2 = this._valueDeserializer.supportsUpdate(ctxt.getConfig());
        if (B2.equals(Boolean.FALSE) || this._valueTypeDeserializer != null) {
