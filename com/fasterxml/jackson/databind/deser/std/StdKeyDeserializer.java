...
implements Serializable {
    ...
    public Object deserializeKey(String key, DeserializationContext ctxt) throws IOException {
        ...
        try {
            ...
            return ctxt.handleWeirdKey(this._keyClass, key, "not a valid representation, problem: (%s) %s", re2.getClass().getName(), ClassUtil.exceptionMessage(re2));
        }
        ...
        switch (this._kind) {
            ...
            case 12: {
                try {
                    ...
                    return this._weirdKey(ctxt, key, e4);
                }
            }
            case 13: {
                try {
                    ...
                    return this._weirdKey(ctxt, key, e5);
                }
            }
            case 14: {
                try {
                    ...
                    return this._weirdKey(ctxt, key, e6);
                }
            }
            case 15: {
                try {
            ...
            case 17: {
                try {
                    ...
                    return this._weirdKey(ctxt, key, e8);
                }
            }
        }
    ...
    protected Object _weirdKey(DeserializationContext ctxt, String key, Exception e2) throws IOException {
        return ctxt.handleWeirdKey(this._keyClass, key, "problem: %s", ClassUtil.exceptionMessage(e2));
    }
    ...
    extends StdKeyDeserializer {
        ...
        protected EnumKD(EnumResolver er2, AnnotatedMethod factory) {
            ...
            this._enumDefaultValue = er2.getDefaultValue();
        }
        ...
        public Object _parse(String key, DeserializationContext ctxt) throws IOException {
            ...
            if (this._factory != null) {
                try {
                    ...
                    ClassUtil.unwrapAndThrowAsIAE(e3);
                }
            }
            if ((e2 = (res = ctxt.isEnabled(DeserializationFeature.READ_ENUMS_USING_TO_STRING) ? this._getToStringResolver(ctxt) : this._byNameResolver).findEnum(key)) == null) {
    ...
    implements Serializable {
        ...
        public final Object deserializeKey(String key, DeserializationContext ctxt) throws IOException {
            ...
            try {
                ...
                return ctxt.handleWeirdKey(this._keyClass, key, "not a valid representation: %s", re2.getMessage());
            }
        }
