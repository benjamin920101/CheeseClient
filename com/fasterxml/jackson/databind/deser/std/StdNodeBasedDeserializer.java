...
implements ResolvableDeserializer {
    ...
    @Override
    public T deserialize(JsonParser jp2, DeserializationContext ctxt) throws IOException {
        JsonNode n2 = (JsonNode)this._treeDeserializer.deserialize(jp2, ctxt);
        return this.convert(n2, ctxt);
    }

    @Override
    public Object deserializeWithType(JsonParser jp2, DeserializationContext ctxt, TypeDeserializer td) throws IOException, JsonProcessingException {
        JsonNode n2 = (JsonNode)this._treeDeserializer.deserializeWithType(jp2, ctxt, td);
        return this.convert(n2, ctxt);
    }
}
