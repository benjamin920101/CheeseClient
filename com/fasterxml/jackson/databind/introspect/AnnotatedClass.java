...
implements TypeResolutionContext {
    ...
    AnnotatedClass(JavaType type, Class<?> rawType, List<JavaType> superTypes, Class<?> primaryMixIn, Annotations classAnnotations, TypeBindings bindings, AnnotationIntrospector aintr, ClassIntrospector.MixInResolver mir, TypeFactory tf2) {
        this._type = type;
        this._class = rawType;
    ...
    public boolean isNonStaticInnerClass() {
        Boolean B2 = this._nonStaticInnerClass;
        if (B2 == null) {
            this._nonStaticInnerClass = B2 = Boolean.valueOf(ClassUtil.isNonStaticInnerClass(this._class));
        }
        return B2;
    }

    private final List<AnnotatedField> _fields() {
        List<AnnotatedField> f2 = this._fields;
        if (f2 == null) {
            f2 = this._type == null ? Collections.emptyList() : AnnotatedFieldCollector.collectFields(this._annotationIntrospector, this, this._mixInResolver, this._typeFactory, this._type);
            this._fields = f2;
        }
        return f2;
    }
    ...
    private final Creators _creators() {
        Creators c2 = this._creators;
        if (c2 == null) {
            c2 = this._type == null ? NO_CREATORS : AnnotatedCreatorCollector.collectCreators(this._annotationIntrospector, this, this._type, this._primaryMixIn);
            this._creators = c2;
        }
        return c2;
    }
