...
implements Serializable {
    ...
    @Override
    public AnnotatedField withAnnotations(AnnotationMap ann2) {
        return new AnnotatedField(this._typeContext, this._field, ann2);
    }
    ...
    public void setValue(Object pojo, Object value) throws IllegalArgumentException {
        try {
            ...
            throw new IllegalArgumentException("Failed to setValue() for field " + this.getFullName() + ": " + e2.getMessage(), e2);
        }
    }
    ...
    public Object getValue(Object pojo) throws IllegalArgumentException {
        try {
            ...
            throw new IllegalArgumentException("Failed to getValue() for field " + this.getFullName() + ": " + e2.getMessage(), e2);
        }
    }
    ...
    Object readResolve() {
        ...
        try {
            Field f2 = clazz.getDeclaredField(this._serialization.name);
            if (!f2.isAccessible()) {
                ClassUtil.checkAndFixAccess(f2, false);
            }
            return new AnnotatedField(null, f2, null);
        }
        catch (Exception e2) {
    ...
    implements Serializable {
        ...
        public Serialization(Field f2) {
            this.clazz = f2.getDeclaringClass();
