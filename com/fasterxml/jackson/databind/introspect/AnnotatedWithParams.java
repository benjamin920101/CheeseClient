...
extends AnnotatedMember {
    ...
    public final void addOrOverrideParam(int paramIndex, Annotation a2) {
    ...
    protected AnnotatedParameter replaceParameterAnnotations(int index, AnnotationMap ann2) {
        this._paramAnnotations[index] = ann2;
