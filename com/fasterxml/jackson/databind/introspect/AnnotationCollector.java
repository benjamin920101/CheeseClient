...
public abstract class AnnotationCollector {
    ...
    protected AnnotationCollector(Object d2) {
        this._data = d2;
    }
    ...
    extends AnnotationCollector {
        ...
        public Annotations asAnnotations() {
            if (this._annotations.size() == 2) {
                ...
                Map.Entry<Class<?>, Annotation> en1 = it2.next();
                Map.Entry<Class<?>, Annotation> en2 = it2.next();
        ...
        public AnnotationMap asAnnotationMap() {
            ...
            for (Annotation ann2 : this._annotations.values()) {
                result.add(ann2);
            }
            return result;
        }
        ...
        @Override
        public boolean isPresent(Annotation ann2) {
            return this._annotations.containsKey(ann2.annotationType());
        }

        @Override
        public AnnotationCollector addOrOverride(Annotation ann2) {
            this._annotations.put(ann2.annotationType(), ann2);
            return this;
        }
    }
    ...
    extends AnnotationCollector {
        ...
        @Override
        public boolean isPresent(Annotation ann2) {
            return ann2.annotationType() == this._type;
        }
        ...
        public AnnotationCollector addOrOverride(Annotation ann2) {
            ...
            return new NCollector(this._data, this._type, this._value, type, ann2);
        }
    }
    ...
    extends AnnotationCollector {
        ...
        @Override
        public AnnotationCollector addOrOverride(Annotation ann2) {
            return new OneCollector(this._data, ann2.annotationType(), ann2);
        }
    }
}
