...
extends TypeIdResolverBase {
    ...
    protected JavaType _typeFromId(String id2, DatabindContext ctxt) throws IOException {
        JavaType t2 = ctxt.resolveAndValidateSubType(this._baseType, id2, this._subTypeValidator);
        if (t2 == null && ctxt instanceof DeserializationContext) {
            return ((DeserializationContext)ctxt).handleUnknownTypeId(this._baseType, id2, this, "no such class found");
        }
        return t2;
    }
