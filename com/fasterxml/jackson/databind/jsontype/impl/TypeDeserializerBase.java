...
implements Serializable {
    ...
    public String toString() {
        ...
        sb2.append('[').append(this.getClass().getName());
        sb2.append("; base-type:").append(this._baseType);
        sb2.append("; id-resolver: ").append(this._idResolver);
        sb2.append(']');
        return sb2.toString();
    }
    ...
    @Deprecated
    protected Object _deserializeWithNativeTypeId(JsonParser jp2, DeserializationContext ctxt) throws IOException {
        return this._deserializeWithNativeTypeId(jp2, ctxt, jp2.getTypeId());
    }

    protected Object _deserializeWithNativeTypeId(JsonParser p2, DeserializationContext ctxt, Object typeId) throws IOException {
