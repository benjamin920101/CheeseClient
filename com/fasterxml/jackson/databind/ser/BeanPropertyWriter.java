...
implements Serializable {
    ...
    public void setNonTrivialBaseType(JavaType t2) {
        this._nonTrivialBaseType = t2;
    }
    ...
    protected JsonSerializer<Object> _findAndAddDynamic(PropertySerializerMap map, Class<?> type, SerializerProvider provider) throws JsonMappingException {
        ...
        if (this._nonTrivialBaseType != null) {
            JavaType t2 = provider.constructSpecializedType(this._nonTrivialBaseType, type);
            result = map.findAndAddPrimarySerializer(t2, provider, (BeanProperty)this);
        } else {
    ...
    public String toString() {
        ...
        sb2.append("property '").append(this.getName()).append("' (");
        if (this._accessorMethod != null) {
            sb2.append("via method ").append(this._accessorMethod.getDeclaringClass().getName()).append("#").append(this._accessorMethod.getName());
        } else if (this._field != null) {
            sb2.append("field \"").append(this._field.getDeclaringClass().getName()).append("#").append(this._field.getName());
        } else {
            sb2.append("virtual");
        }
        if (this._serializer == null) {
