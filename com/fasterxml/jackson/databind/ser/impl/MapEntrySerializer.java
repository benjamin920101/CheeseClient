...
implements ContextualSerializer {
    ...
    public boolean isEmpty(SerializerProvider prov, Map.Entry<?, ?> entry) {
        ...
        if (valueSer == null && (valueSer = this._dynamicValueSerializers.serializerFor(cc2 = value.getClass())) == null) {
            try {
    ...
    @Override
    public void serializeWithType(Map.Entry<?, ?> value, JsonGenerator g2, SerializerProvider provider, TypeSerializer typeSer) throws IOException {
        g2.setCurrentValue(value);
        WritableTypeId typeIdDef = typeSer.writeTypePrefix(g2, typeSer.typeId(value, JsonToken.START_OBJECT));
        this.serializeDynamic(value, g2, provider);
    ...
    protected void serializeDynamic(Map.Entry<?, ?> value, JsonGenerator gen, SerializerProvider provider) throws IOException {
        ...
        try {
            ...
            this.wrapAndThrow(provider, (Throwable)e2, value, keyDesc);
        }
    }
