...
SchemaAware {
    ...
    public void serialize(Object bean, JsonGenerator gen, SerializerProvider prov) throws IOException {
        try {
            ...
            if (ser == null) {
                ...
                ser = prov.findTypedValueSerializer(c2, true, this._property);
            }
            ser.serialize(value, gen, prov);
        }
        catch (Exception e2) {
            this.wrapAndThrow(prov, (Throwable)e2, bean, this._accessor.getName() + "()");
        }
    }
    ...
    public void serializeWithType(Object bean, JsonGenerator gen, SerializerProvider provider, TypeSerializer typeSer0) throws IOException {
        ...
        try {
            ...
            TypeSerializerRerouter rr2 = new TypeSerializerRerouter(typeSer0, bean);
            ser.serializeWithType(value, gen, provider, rr2);
        }
        catch (Exception e2) {
            this.wrapAndThrow(provider, (Throwable)e2, bean, this._accessor.getName() + "()");
        }
    }
    ...
    extends TypeSerializer {
        ...
        public TypeSerializerRerouter(TypeSerializer ts2, Object ob2) {
            this._typeSerializer = ts2;
            this._forObject = ob2;
        }
        ...
        @Override
        public WritableTypeId writeTypePrefix(JsonGenerator g2, WritableTypeId typeId) throws IOException {
            typeId.forValue = this._forObject;
            return this._typeSerializer.writeTypePrefix(g2, typeId);
        }

        @Override
        public WritableTypeId writeTypeSuffix(JsonGenerator g2, WritableTypeId typeId) throws IOException {
            return this._typeSerializer.writeTypeSuffix(g2, typeId);
        }
