...
implements ContextualSerializer {
    ...
    protected boolean _useStatic(SerializerProvider provider, BeanProperty property, JavaType referredType) {
        ...
        if (intr != null && property != null && (ann2 = property.getMember()) != null) {
    ...
    @Override
    public void serialize(T ref, JsonGenerator g2, SerializerProvider provider) throws IOException {
        ...
        if (this._valueTypeSerializer != null) {
            ser.serializeWithType(value, g2, provider, this._valueTypeSerializer);
        } else {
    ...
    @Override
    public void serializeWithType(T ref, JsonGenerator g2, SerializerProvider provider, TypeSerializer typeSer) throws IOException {
        Object value = this._getReferencedIfPresent(ref);
        if (value == null) {
            if (this._unwrapper == null) {
                provider.defaultSerializeNull(g2);
        ...
        ser.serializeWithType(value, g2, provider, typeSer);
    }
