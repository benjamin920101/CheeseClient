...
extends DateTimeSerializerBase<Date> {
    ...
    @Override
    public void serialize(Date value, JsonGenerator g2, SerializerProvider provider) throws IOException {
        if (this._asTimestamp(provider)) {
            g2.writeNumber(this._timestamp(value));
            return;
        }
        if (this._customFormat == null) {
            g2.writeString(value.toString());
            return;
        }
        this._serializeAsString(value, g2, provider);
    }
}
