...
public abstract class StdKeySerializers {
    ...
    extends StdSerializer<Object> {
        ...
        @Override
        public void serialize(Object value, JsonGenerator g2, SerializerProvider serializers) throws IOException {
            if (serializers.isEnabled(SerializationFeature.WRITE_ENUMS_USING_TO_STRING)) {
                g2.writeFieldName(value.toString());
                return;
            }
            Enum en2 = (Enum)value;
            if (serializers.isEnabled(SerializationFeature.WRITE_ENUM_KEYS_USING_INDEX)) {
                g2.writeFieldName(String.valueOf(en2.ordinal()));
                return;
            }
            g2.writeFieldName(this._values.serializedValueFor(en2));
        }
    }
    ...
    extends StdSerializer<Object> {
        ...
        public void serialize(Object value, JsonGenerator g2, SerializerProvider provider) throws IOException {
            g2.writeFieldName((String)value);
        }
    }
    ...
    extends StdSerializer<Object> {
        ...
        public void serialize(Object value, JsonGenerator g2, SerializerProvider provider) throws IOException {
            ...
            ser.serialize(value, g2, provider);
        }
    ...
    extends StdSerializer<Object> {
        ...
        public void serialize(Object value, JsonGenerator g2, SerializerProvider provider) throws IOException {
            switch (this._typeId) {
                ...
                case 2: {
                    provider.defaultSerializeDateKey(((Calendar)value).getTimeInMillis(), g2);
                    break;
                }
                case 3: {
                    g2.writeFieldName(((Class)value).getName());
                    break;
                }
                case 4: {
                    String key;
                    if (provider.isEnabled(SerializationFeature.WRITE_ENUMS_USING_TO_STRING)) {
                        ...
                        Enum e2 = (Enum)value;
                        key = provider.isEnabled(SerializationFeature.WRITE_ENUM_KEYS_USING_INDEX) ? String.valueOf(e2.ordinal()) : e2.name();
                    }
