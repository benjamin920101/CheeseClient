...
extends StdScalarSerializer<UUID> {
    ...
    private static final byte[] _asBytes(UUID uuid) {
        ...
        long hi2 = uuid.getMostSignificantBits();
        long lo2 = uuid.getLeastSignificantBits();
        UUIDSerializer._appendInt((int)(hi2 >> 32), buffer, 0);
        UUIDSerializer._appendInt((int)hi2, buffer, 4);
        UUIDSerializer._appendInt((int)(lo2 >> 32), buffer, 8);
        UUIDSerializer._appendInt((int)lo2, buffer, 12);
        return buffer;
    }
