...
implements Serializable {
    ...
    public TypeParser(TypeFactory f2) {
        this._factory = f2;
    }

    public TypeParser withFactory(TypeFactory f2) {
        return f2 == this._factory ? this : new TypeParser(f2);
    }
    ...
    protected JavaType parseType(MyTokenizer tokens) throws IllegalArgumentException {
        ...
        if (tokens.hasMoreTokens()) {
            ...
            if ("<".equals(token)) {
                ...
                TypeBindings b2 = TypeBindings.create(base, parameterTypes);
                return this._factory._fromClass(null, base, b2);
            }
    ...
    protected Class<?> findClass(String className, MyTokenizer tokens) {
        try {
            ...
            throw this._problem(tokens, "Cannot locate class '" + className + "', problem: " + e2.getMessage());
        }
    }
