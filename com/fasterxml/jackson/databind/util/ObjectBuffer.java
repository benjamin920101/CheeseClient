...
public final class ObjectBuffer {
    ...
    public void completeAndClearBuffer(Object[] lastChunk, int lastChunkEntries, List<Object> resultList) {
        for (LinkedNode<Object[]> n2 = this._head; n2 != null; n2 = n2.next()) {
            Object[] curr = n2.value();
            int len = curr.length;
            for (int i2 = 0; i2 < len; ++i2) {
                resultList.add(curr[i2]);
            }
        }
        for (int i3 = 0; i3 < lastChunkEntries; ++i3) {
            resultList.add(lastChunk[i3]);
        }
        this._reset();
    }
