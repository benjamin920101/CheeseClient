...
Cloneable {
    ...
    public int[] getRGB(BufferedImage image, int x2, int y2, int width, int height, int[] pixels) {
    ...
    public void setRGB(BufferedImage image, int x2, int y2, int width, int height, int[] pixels) {
        int type = image.getType();
        if (type == 2 || type == 1) {
