        ...
        return new AbstractSet<Map.Entry<Byte, Float>>(){
            ...
            public boolean contains(Object o2) {
                if (o2 instanceof Map.Entry) {
                    ...
                    return TByteFloatMapDecorator.this.containsKey(k2) && TByteFloatMapDecorator.this.get(k2).equals(v2);
                }
                return false;
            }
            ...
            public Iterator<Map.Entry<Byte, Float>> iterator() {
                return new Iterator<Map.Entry<Byte, Float>>(){
                    ...
                    public Map.Entry<Byte, Float> next() {
                        ...
                        final Float v2 = iv2 == TByteFloatMapDecorator.this._map.getNoEntryValue() ? null : TByteFloatMapDecorator.this.wrapValue(iv2);
