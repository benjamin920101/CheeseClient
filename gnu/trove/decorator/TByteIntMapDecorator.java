...
Cloneable {
    ...
    public Integer put(Byte key, Integer value) {
        ...
        int retval = this._map.put(k2, v2 = value == null ? this._map.getNoEntryValue() : this.unwrapValue(value));
        ...
        return new AbstractSet<Map.Entry<Byte, Integer>>(){
            ...
            public boolean contains(Object o2) {
                if (o2 instanceof Map.Entry) {
                    ...
                    return TByteIntMapDecorator.this.containsKey(k2) && TByteIntMapDecorator.this.get(k2).equals(v2);
                }
                return false;
            }
            ...
            public Iterator<Map.Entry<Byte, Integer>> iterator() {
                return new Iterator<Map.Entry<Byte, Integer>>(){
                    ...
                    public Map.Entry<Byte, Integer> next() {
                        ...
                        final Byte key = ik2 == TByteIntMapDecorator.this._map.getNoEntryKey() ? null : TByteIntMapDecorator.this.wrapKey(ik2);
                        int iv2 = this.it.value();
                        final Integer v2 = iv2 == TByteIntMapDecorator.this._map.getNoEntryValue() ? null : TByteIntMapDecorator.this.wrapValue(iv2);
            ...
            @Override
            public boolean add(Map.Entry<Byte, Integer> o2) {
            ...
            @Override
            public boolean addAll(Collection<? extends Map.Entry<Byte, Integer>> c2) {
                throw new UnsupportedOperationException();
            }
    ...
    public void putAll(Map<? extends Byte, ? extends Integer> map) {
        ...
        int i2 = map.size();
        while (i2-- > 0) {
            Map.Entry<? extends Byte, ? extends Integer> e2 = it2.next();
    ...
    public void readExternal(ObjectInput in2) throws IOException, ClassNotFoundException {
        in2.readByte();
        this._map = (TByteIntMap)in2.readObject();
    }
