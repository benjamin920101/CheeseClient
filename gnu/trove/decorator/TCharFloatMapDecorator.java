...
Cloneable {
    ...
    public Float put(Character key, Float value) {
        ...
        float retval = this._map.put(k2, v2 = value == null ? this._map.getNoEntryValue() : this.unwrapValue(value));
        ...
        return new AbstractSet<Map.Entry<Character, Float>>(){
            ...
            public boolean contains(Object o2) {
                if (o2 instanceof Map.Entry) {
                    ...
                    return TCharFloatMapDecorator.this.containsKey(k2) && TCharFloatMapDecorator.this.get(k2).equals(v2);
                }
                return false;
            }
            ...
            public Iterator<Map.Entry<Character, Float>> iterator() {
                return new Iterator<Map.Entry<Character, Float>>(){
                    ...
                    public Map.Entry<Character, Float> next() {
                        ...
                        final Character key = ik2 == TCharFloatMapDecorator.this._map.getNoEntryKey() ? null : TCharFloatMapDecorator.this.wrapKey(ik2);
                        float iv2 = this.it.value();
                        final Float v2 = iv2 == TCharFloatMapDecorator.this._map.getNoEntryValue() ? null : TCharFloatMapDecorator.this.wrapValue(iv2);
            ...
            @Override
            public boolean add(Map.Entry<Character, Float> o2) {
            ...
            @Override
            public boolean addAll(Collection<? extends Map.Entry<Character, Float>> c2) {
                throw new UnsupportedOperationException();
            }
    ...
    public void putAll(Map<? extends Character, ? extends Float> map) {
        ...
        int i2 = map.size();
        while (i2-- > 0) {
            Map.Entry<? extends Character, ? extends Float> e2 = it2.next();
    ...
    public void readExternal(ObjectInput in2) throws IOException, ClassNotFoundException {
        in2.readByte();
        this._map = (TCharFloatMap)in2.readObject();
    }
