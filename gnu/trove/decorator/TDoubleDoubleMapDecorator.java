...
Cloneable {
        ...
        return new AbstractSet<Map.Entry<Double, Double>>(){
            ...
            public boolean contains(Object o2) {
                if (o2 instanceof Map.Entry) {
                    ...
                    return TDoubleDoubleMapDecorator.this.containsKey(k2) && TDoubleDoubleMapDecorator.this.get(k2).equals(v2);
                }
                return false;
            }
            ...
            public Iterator<Map.Entry<Double, Double>> iterator() {
                return new Iterator<Map.Entry<Double, Double>>(){
                    ...
                    public Map.Entry<Double, Double> next() {
                        ...
                        final Double key = ik2 == TDoubleDoubleMapDecorator.this._map.getNoEntryKey() ? null : TDoubleDoubleMapDecorator.this.wrapKey(ik2);
                        double iv2 = this.it.value();
                        final Double v2 = iv2 == TDoubleDoubleMapDecorator.this._map.getNoEntryValue() ? null : TDoubleDoubleMapDecorator.this.wrapValue(iv2);
            ...
            @Override
            public boolean add(Map.Entry<Double, Double> o2) {
            ...
            @Override
            public boolean addAll(Collection<? extends Map.Entry<Double, Double>> c2) {
                throw new UnsupportedOperationException();
            }
    ...
    public void putAll(Map<? extends Double, ? extends Double> map) {
        ...
        int i2 = map.size();
        while (i2-- > 0) {
            Map.Entry<? extends Double, ? extends Double> e2 = it2.next();
    ...
    public void readExternal(ObjectInput in2) throws IOException, ClassNotFoundException {
        in2.readByte();
        this._map = (TDoubleDoubleMap)in2.readObject();
    }
