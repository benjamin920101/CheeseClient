...
Cloneable {
        ...
        return new AbstractSet<Map.Entry<K, Byte>>(){
            ...
            public boolean contains(Object o2) {
                if (o2 instanceof Map.Entry) {
                    ...
                    return TObjectByteMapDecorator.this.containsKey(k2) && TObjectByteMapDecorator.this.get(k2).equals(v2);
                }
                return false;
            }
            ...
            public Iterator<Map.Entry<K, Byte>> iterator() {
                return new Iterator<Map.Entry<K, Byte>>(){
                    ...
                    public Map.Entry<K, Byte> next() {
                        ...
                        final Byte v2 = TObjectByteMapDecorator.this.wrapValue(this.it.value());
            ...
            @Override
            public boolean add(Map.Entry<K, Byte> o2) {
            ...
            @Override
            public boolean addAll(Collection<? extends Map.Entry<K, Byte>> c2) {
                throw new UnsupportedOperationException();
            }
    ...
    public void putAll(Map<? extends K, ? extends Byte> map) {
        Iterator<Map.Entry<K, Byte>> it2 = map.entrySet().iterator();
        int i2 = map.size();
        while (i2-- > 0) {
            Map.Entry<K, Byte> e2 = it2.next();
    ...
    public void readExternal(ObjectInput in2) throws IOException, ClassNotFoundException {
        in2.readByte();
        this._map = (TObjectByteMap)in2.readObject();
    }
