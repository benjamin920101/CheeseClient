...
Cloneable {
    ...
    public Double put(Short key, Double value) {
        ...
        double retval = this._map.put(k2, v2 = value == null ? this._map.getNoEntryValue() : this.unwrapValue(value));
    ...
    public Double get(Object key) {
        ...
        double v2 = this._map.get(k2);
        if (v2 != this._map.getNoEntryValue()) return this.wrapValue(v2);
        return null;
    }
        ...
        return new AbstractSet<Map.Entry<Short, Double>>(){
            ...
            public boolean contains(Object o2) {
                if (o2 instanceof Map.Entry) {
                    ...
                    return TShortDoubleMapDecorator.this.containsKey(k2) && TShortDoubleMapDecorator.this.get(k2).equals(v2);
                }
                return false;
            }
            ...
            public Iterator<Map.Entry<Short, Double>> iterator() {
                return new Iterator<Map.Entry<Short, Double>>(){
                    ...
                    public Map.Entry<Short, Double> next() {
                        ...
                        final Short key = ik2 == TShortDoubleMapDecorator.this._map.getNoEntryKey() ? null : TShortDoubleMapDecorator.this.wrapKey(ik2);
                        double iv2 = this.it.value();
                        final Double v2 = iv2 == TShortDoubleMapDecorator.this._map.getNoEntryValue() ? null : TShortDoubleMapDecorator.this.wrapValue(iv2);
            ...
            @Override
            public boolean add(Map.Entry<Short, Double> o2) {
            ...
            @Override
            public boolean addAll(Collection<? extends Map.Entry<Short, Double>> c2) {
                throw new UnsupportedOperationException();
            }
    ...
    public void putAll(Map<? extends Short, ? extends Double> map) {
        Iterator<Map.Entry<? extends Short, ? extends Double>> it2 = map.entrySet().iterator();
        int i2 = map.size();
        while (i2-- > 0) {
            Map.Entry<? extends Short, ? extends Double> e2 = it2.next();
    ...
    public void readExternal(ObjectInput in2) throws IOException, ClassNotFoundException {
        in2.readByte();
        this._map = (TShortDoubleMap)in2.readObject();
    }
