...
Externalizable {
    ...
    implements TByteSet {
        ...
        public boolean equals(Object other) {
            ...
            int i2 = TByteByteHashMap.this._states.length;
            while (i2-- > 0) {
                if (TByteByteHashMap.this._states[i2] != 1 || that.contains(TByteByteHashMap.this._set[i2])) continue;
                return false;
            }
            return true;
        }
        ...
        public int hashCode() {
            ...
            int i2 = TByteByteHashMap.this._states.length;
            while (i2-- > 0) {
                if (TByteByteHashMap.this._states[i2] != 1) continue;
                hashcode += HashFunctions.hash(TByteByteHashMap.this._set[i2]);
            }
            return hashcode;
        }
