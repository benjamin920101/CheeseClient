...
Externalizable {
    ...
    implements TCharCollection {
        ...
        public boolean remove(char entry) {
            ...
            while (i2-- > 0) {
                ...
                TByteCharHashMap.this.removeAt(i2);
                return true;
            }
            return false;
        }
    ...
    implements TByteSet {
        ...
        public boolean equals(Object other) {
            ...
            int i2 = TByteCharHashMap.this._states.length;
            while (i2-- > 0) {
                if (TByteCharHashMap.this._states[i2] != 1 || that.contains(TByteCharHashMap.this._set[i2])) continue;
                return false;
            }
            return true;
        }
        ...
        public int hashCode() {
            ...
            int i2 = TByteCharHashMap.this._states.length;
            while (i2-- > 0) {
                if (TByteCharHashMap.this._states[i2] != 1) continue;
                hashcode += HashFunctions.hash(TByteCharHashMap.this._set[i2]);
            }
            return hashcode;
        }
