...
Externalizable {
    ...
    implements TDoubleCollection {
        ...
        public boolean remove(double entry) {
            ...
            while (i2-- > 0) {
                ...
                TByteDoubleHashMap.this.removeAt(i2);
                return true;
            }
            return false;
        }
    ...
    implements TByteSet {
        ...
        public boolean equals(Object other) {
            ...
            int i2 = TByteDoubleHashMap.this._states.length;
            while (i2-- > 0) {
                if (TByteDoubleHashMap.this._states[i2] != 1 || that.contains(TByteDoubleHashMap.this._set[i2])) continue;
                return false;
            }
            return true;
        }
        ...
        public int hashCode() {
            ...
            int i2 = TByteDoubleHashMap.this._states.length;
            while (i2-- > 0) {
                if (TByteDoubleHashMap.this._states[i2] != 1) continue;
                hashcode += HashFunctions.hash(TByteDoubleHashMap.this._set[i2]);
            }
            return hashcode;
        }
