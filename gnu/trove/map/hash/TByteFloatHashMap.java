...
Externalizable {
    ...
    implements TFloatCollection {
        ...
        public boolean remove(float entry) {
            ...
            while (i2-- > 0) {
                ...
                TByteFloatHashMap.this.removeAt(i2);
                return true;
            }
            return false;
        }
    ...
    implements TByteSet {
        ...
        public boolean equals(Object other) {
            ...
            int i2 = TByteFloatHashMap.this._states.length;
            while (i2-- > 0) {
                if (TByteFloatHashMap.this._states[i2] != 1 || that.contains(TByteFloatHashMap.this._set[i2])) continue;
                return false;
            }
            return true;
        }
        ...
        public int hashCode() {
            ...
            int i2 = TByteFloatHashMap.this._states.length;
            while (i2-- > 0) {
                if (TByteFloatHashMap.this._states[i2] != 1) continue;
                hashcode += HashFunctions.hash(TByteFloatHashMap.this._set[i2]);
            }
            return hashcode;
        }
