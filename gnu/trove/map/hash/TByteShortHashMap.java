...
Externalizable {
    ...
    implements TShortCollection {
        ...
        public boolean remove(short entry) {
            ...
            while (i2-- > 0) {
                ...
                TByteShortHashMap.this.removeAt(i2);
                return true;
            }
            return false;
        }
    ...
    implements TByteSet {
        ...
        public boolean equals(Object other) {
            ...
            int i2 = TByteShortHashMap.this._states.length;
            while (i2-- > 0) {
                if (TByteShortHashMap.this._states[i2] != 1 || that.contains(TByteShortHashMap.this._set[i2])) continue;
                return false;
            }
            return true;
        }
        ...
        public int hashCode() {
            ...
            int i2 = TByteShortHashMap.this._states.length;
            while (i2-- > 0) {
                if (TByteShortHashMap.this._states[i2] != 1) continue;
                hashcode += HashFunctions.hash(TByteShortHashMap.this._set[i2]);
            }
            return hashcode;
        }
