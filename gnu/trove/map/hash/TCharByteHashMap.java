...
Externalizable {
    ...
    implements TByteCollection {
        ...
        public boolean remove(byte entry) {
            ...
            while (i2-- > 0) {
                ...
                TCharByteHashMap.this.removeAt(i2);
                return true;
            }
            return false;
        }
    ...
    implements TCharSet {
        ...
        public boolean equals(Object other) {
            ...
            int i2 = TCharByteHashMap.this._states.length;
            while (i2-- > 0) {
                if (TCharByteHashMap.this._states[i2] != 1 || that.contains(TCharByteHashMap.this._set[i2])) continue;
                return false;
            }
            return true;
        }
        ...
        public int hashCode() {
            ...
            int i2 = TCharByteHashMap.this._states.length;
            while (i2-- > 0) {
                if (TCharByteHashMap.this._states[i2] != 1) continue;
                hashcode += HashFunctions.hash(TCharByteHashMap.this._set[i2]);
            }
            return hashcode;
        }
