...
Externalizable {
    ...
    implements TDoubleCollection {
        ...
        public boolean remove(double entry) {
            ...
            while (i2-- > 0) {
                ...
                TCharDoubleHashMap.this.removeAt(i2);
                return true;
            }
            return false;
        }
    ...
    implements TCharSet {
        ...
        public boolean equals(Object other) {
            ...
            int i2 = TCharDoubleHashMap.this._states.length;
            while (i2-- > 0) {
                if (TCharDoubleHashMap.this._states[i2] != 1 || that.contains(TCharDoubleHashMap.this._set[i2])) continue;
                return false;
            }
            return true;
        }
        ...
        public int hashCode() {
            ...
            int i2 = TCharDoubleHashMap.this._states.length;
            while (i2-- > 0) {
                if (TCharDoubleHashMap.this._states[i2] != 1) continue;
                hashcode += HashFunctions.hash(TCharDoubleHashMap.this._set[i2]);
            }
            return hashcode;
        }
