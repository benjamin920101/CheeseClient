...
Externalizable {
    ...
    implements TFloatCollection {
        ...
        public boolean remove(float entry) {
            ...
            while (i2-- > 0) {
                ...
                TCharFloatHashMap.this.removeAt(i2);
                return true;
            }
            return false;
        }
    ...
    implements TCharSet {
        ...
        public boolean equals(Object other) {
            ...
            int i2 = TCharFloatHashMap.this._states.length;
            while (i2-- > 0) {
                if (TCharFloatHashMap.this._states[i2] != 1 || that.contains(TCharFloatHashMap.this._set[i2])) continue;
                return false;
            }
            return true;
        }
        ...
        public int hashCode() {
            ...
            int i2 = TCharFloatHashMap.this._states.length;
            while (i2-- > 0) {
                if (TCharFloatHashMap.this._states[i2] != 1) continue;
                hashcode += HashFunctions.hash(TCharFloatHashMap.this._set[i2]);
            }
            return hashcode;
        }
