...
Externalizable {
    ...
    implements TCharSet {
        ...
        public boolean equals(Object other) {
            ...
            int i2 = TCharIntHashMap.this._states.length;
            while (i2-- > 0) {
                if (TCharIntHashMap.this._states[i2] != 1 || that.contains(TCharIntHashMap.this._set[i2])) continue;
                return false;
            }
            return true;
        }
        ...
        public int hashCode() {
            ...
            int i2 = TCharIntHashMap.this._states.length;
            while (i2-- > 0) {
                if (TCharIntHashMap.this._states[i2] != 1) continue;
                hashcode += HashFunctions.hash(TCharIntHashMap.this._set[i2]);
            }
            return hashcode;
        }
