...
Externalizable {
    ...
    implements TLongCollection {
        ...
        public boolean remove(long entry) {
            ...
            int i2 = values.length;
            while (i2-- > 0) {
                if (set[i2] == '\u0000' || set[i2] == '\u0002' || entry != values[i2]) continue;
                TCharLongHashMap.this.removeAt(i2);
                return true;
            }
            return false;
        }
    ...
    implements TCharSet {
        ...
        public boolean equals(Object other) {
            ...
            int i2 = TCharLongHashMap.this._states.length;
            while (i2-- > 0) {
                if (TCharLongHashMap.this._states[i2] != 1 || that.contains(TCharLongHashMap.this._set[i2])) continue;
                return false;
            }
            return true;
        }
        ...
        public int hashCode() {
            ...
            int i2 = TCharLongHashMap.this._states.length;
            while (i2-- > 0) {
                if (TCharLongHashMap.this._states[i2] != 1) continue;
                hashcode += HashFunctions.hash(TCharLongHashMap.this._set[i2]);
            }
            return hashcode;
        }
