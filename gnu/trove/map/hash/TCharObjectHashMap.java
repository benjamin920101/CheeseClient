...
Externalizable {
    ...
    public void readExternal(ObjectInput in2) throws IOException, ClassNotFoundException {
        ...
        this.no_entry_key = in2.readChar();
    ...
    implements TCharSet {
        ...
        public boolean equals(Object other) {
            ...
            int i2 = TCharObjectHashMap.this._states.length;
            while (i2-- > 0) {
                if (TCharObjectHashMap.this._states[i2] != 1 || that.contains(TCharObjectHashMap.this._set[i2])) continue;
                return false;
            }
            return true;
        }
        ...
        public int hashCode() {
            ...
            int i2 = TCharObjectHashMap.this._states.length;
            while (i2-- > 0) {
                if (TCharObjectHashMap.this._states[i2] != 1) continue;
                hashcode += HashFunctions.hash(TCharObjectHashMap.this._set[i2]);
            }
            return hashcode;
        }
        ...
        public String toString() {
            ...
            while (i2-- > 0) {
                ...
                buf.append(TCharObjectHashMap.this._set[i2]);
            }
            return buf.toString();
        }
