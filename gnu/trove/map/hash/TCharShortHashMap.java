...
Externalizable {
    ...
    implements TCharSet {
        ...
        public boolean equals(Object other) {
            ...
            int i2 = TCharShortHashMap.this._states.length;
            while (i2-- > 0) {
                if (TCharShortHashMap.this._states[i2] != 1 || that.contains(TCharShortHashMap.this._set[i2])) continue;
                return false;
            }
            return true;
        }
        ...
        public int hashCode() {
            ...
            int i2 = TCharShortHashMap.this._states.length;
            while (i2-- > 0) {
                if (TCharShortHashMap.this._states[i2] != 1) continue;
                hashcode += HashFunctions.hash(TCharShortHashMap.this._set[i2]);
            }
            return hashcode;
        }
