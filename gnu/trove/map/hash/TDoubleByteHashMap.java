...
Externalizable {
    ...
    implements TByteCollection {
        ...
        public boolean remove(byte entry) {
            ...
            while (i2-- > 0) {
                ...
                TDoubleByteHashMap.this.removeAt(i2);
                return true;
            }
            return false;
        }
    ...
    implements TDoubleSet {
        ...
        public boolean equals(Object other) {
            ...
            int i2 = TDoubleByteHashMap.this._states.length;
            while (i2-- > 0) {
                if (TDoubleByteHashMap.this._states[i2] != 1 || that.contains(TDoubleByteHashMap.this._set[i2])) continue;
                return false;
            }
            return true;
        }
        ...
        public int hashCode() {
            ...
            int i2 = TDoubleByteHashMap.this._states.length;
            while (i2-- > 0) {
                if (TDoubleByteHashMap.this._states[i2] != 1) continue;
                hashcode += HashFunctions.hash(TDoubleByteHashMap.this._set[i2]);
            }
            return hashcode;
        }
