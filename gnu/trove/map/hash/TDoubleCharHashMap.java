...
Externalizable {
    ...
    implements TCharCollection {
        ...
        public boolean remove(char entry) {
            ...
            while (i2-- > 0) {
                ...
                TDoubleCharHashMap.this.removeAt(i2);
                return true;
            }
            return false;
        }
    ...
    implements TDoubleSet {
        ...
        public boolean equals(Object other) {
            ...
            int i2 = TDoubleCharHashMap.this._states.length;
            while (i2-- > 0) {
                if (TDoubleCharHashMap.this._states[i2] != 1 || that.contains(TDoubleCharHashMap.this._set[i2])) continue;
                return false;
            }
            return true;
        }
        ...
        public int hashCode() {
            ...
            int i2 = TDoubleCharHashMap.this._states.length;
            while (i2-- > 0) {
                if (TDoubleCharHashMap.this._states[i2] != 1) continue;
                hashcode += HashFunctions.hash(TDoubleCharHashMap.this._set[i2]);
            }
            return hashcode;
        }
