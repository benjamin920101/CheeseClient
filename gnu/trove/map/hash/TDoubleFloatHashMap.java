...
Externalizable {
    ...
    implements TDoubleSet {
        ...
        public boolean equals(Object other) {
            ...
            int i2 = TDoubleFloatHashMap.this._states.length;
            while (i2-- > 0) {
                if (TDoubleFloatHashMap.this._states[i2] != 1 || that.contains(TDoubleFloatHashMap.this._set[i2])) continue;
                return false;
            }
            return true;
        }
        ...
        public int hashCode() {
            ...
            int i2 = TDoubleFloatHashMap.this._states.length;
            while (i2-- > 0) {
                if (TDoubleFloatHashMap.this._states[i2] != 1) continue;
                hashcode += HashFunctions.hash(TDoubleFloatHashMap.this._set[i2]);
            }
            return hashcode;
        }
