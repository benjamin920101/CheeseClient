...
Externalizable {
    ...
    implements TDoubleCollection {
        ...
        public boolean remove(double entry) {
            ...
            while (i2-- > 0) {
                ...
                TFloatDoubleHashMap.this.removeAt(i2);
                return true;
            }
            return false;
        }
    ...
    implements TFloatSet {
        ...
        public boolean equals(Object other) {
            ...
            int i2 = TFloatDoubleHashMap.this._states.length;
            while (i2-- > 0) {
                if (TFloatDoubleHashMap.this._states[i2] != 1 || that.contains(TFloatDoubleHashMap.this._set[i2])) continue;
                return false;
            }
            return true;
        }
        ...
        public int hashCode() {
            ...
            int i2 = TFloatDoubleHashMap.this._states.length;
            while (i2-- > 0) {
                if (TFloatDoubleHashMap.this._states[i2] != 1) continue;
                hashcode += HashFunctions.hash(TFloatDoubleHashMap.this._set[i2]);
            }
            return hashcode;
        }
