...
Externalizable {
    ...
    implements TFloatCollection {
        ...
        public boolean remove(float entry) {
            ...
            int i2 = values.length;
            while (i2-- > 0) {
                if (set[i2] == 0.0f || set[i2] == 2.0f || entry != values[i2]) continue;
                TFloatFloatHashMap.this.removeAt(i2);
                return true;
            }
            return false;
        }
    ...
    implements TFloatSet {
        ...
        public boolean equals(Object other) {
            ...
            int i2 = TFloatFloatHashMap.this._states.length;
            while (i2-- > 0) {
                if (TFloatFloatHashMap.this._states[i2] != 1 || that.contains(TFloatFloatHashMap.this._set[i2])) continue;
                return false;
            }
            return true;
        }
        ...
        public int hashCode() {
            ...
            int i2 = TFloatFloatHashMap.this._states.length;
            while (i2-- > 0) {
                if (TFloatFloatHashMap.this._states[i2] != 1) continue;
                hashcode += HashFunctions.hash(TFloatFloatHashMap.this._set[i2]);
            }
            return hashcode;
        }
