...
Externalizable {
    ...
    public void readExternal(ObjectInput in2) throws IOException, ClassNotFoundException {
        ...
        this.no_entry_key = in2.readFloat();
    ...
    extends MapBackedView<V> {
        ...
        public boolean removeElement(V value) {
            ...
            while (i2-- > 0) {
                ...
                TFloatObjectHashMap.this.removeAt(i2);
                return true;
            }
            return false;
        }
    ...
    implements TFloatSet {
        ...
        public boolean equals(Object other) {
            ...
            int i2 = TFloatObjectHashMap.this._states.length;
            while (i2-- > 0) {
                if (TFloatObjectHashMap.this._states[i2] != 1 || that.contains(TFloatObjectHashMap.this._set[i2])) continue;
                return false;
            }
            return true;
        }
        ...
        public int hashCode() {
            ...
            int i2 = TFloatObjectHashMap.this._states.length;
            while (i2-- > 0) {
                if (TFloatObjectHashMap.this._states[i2] != 1) continue;
                hashcode += HashFunctions.hash(TFloatObjectHashMap.this._set[i2]);
            }
            return hashcode;
        }
        ...
        public String toString() {
            ...
            while (i2-- > 0) {
                ...
                buf.append(TFloatObjectHashMap.this._set[i2]);
            }
            return buf.toString();
        }
