...
Externalizable {
    ...
    implements TShortCollection {
        ...
        public boolean remove(short entry) {
            ...
            while (i2-- > 0) {
                ...
                TFloatShortHashMap.this.removeAt(i2);
                return true;
            }
            return false;
        }
    ...
    implements TFloatSet {
        ...
        public boolean equals(Object other) {
            ...
            int i2 = TFloatShortHashMap.this._states.length;
            while (i2-- > 0) {
                if (TFloatShortHashMap.this._states[i2] != 1 || that.contains(TFloatShortHashMap.this._set[i2])) continue;
                return false;
            }
            return true;
        }
        ...
        public int hashCode() {
            ...
            int i2 = TFloatShortHashMap.this._states.length;
            while (i2-- > 0) {
                if (TFloatShortHashMap.this._states[i2] != 1) continue;
                hashcode += HashFunctions.hash(TFloatShortHashMap.this._set[i2]);
            }
            return hashcode;
        }
