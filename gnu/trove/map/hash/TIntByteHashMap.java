...
Externalizable {
    ...
    implements TByteCollection {
        ...
        public boolean remove(byte entry) {
            ...
            while (i2-- > 0) {
                ...
                TIntByteHashMap.this.removeAt(i2);
                return true;
            }
            return false;
        }
    ...
    implements TIntSet {
        ...
        public boolean equals(Object other) {
            ...
            int i2 = TIntByteHashMap.this._states.length;
            while (i2-- > 0) {
                if (TIntByteHashMap.this._states[i2] != 1 || that.contains(TIntByteHashMap.this._set[i2])) continue;
                return false;
            }
            return true;
        }
        ...
        public int hashCode() {
            ...
            int i2 = TIntByteHashMap.this._states.length;
            while (i2-- > 0) {
                if (TIntByteHashMap.this._states[i2] != 1) continue;
                hashcode += HashFunctions.hash(TIntByteHashMap.this._set[i2]);
            }
            return hashcode;
        }
