...
Externalizable {
    ...
    implements TDoubleCollection {
        ...
        public boolean remove(double entry) {
            ...
            while (i2-- > 0) {
                ...
                TIntDoubleHashMap.this.removeAt(i2);
                return true;
            }
            return false;
        }
    ...
    implements TIntSet {
        ...
        public boolean equals(Object other) {
            ...
            int i2 = TIntDoubleHashMap.this._states.length;
            while (i2-- > 0) {
                if (TIntDoubleHashMap.this._states[i2] != 1 || that.contains(TIntDoubleHashMap.this._set[i2])) continue;
                return false;
            }
            return true;
        }
        ...
        public int hashCode() {
            ...
            int i2 = TIntDoubleHashMap.this._states.length;
            while (i2-- > 0) {
                if (TIntDoubleHashMap.this._states[i2] != 1) continue;
                hashcode += HashFunctions.hash(TIntDoubleHashMap.this._set[i2]);
            }
            return hashcode;
        }
