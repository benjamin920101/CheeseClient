...
Externalizable {
    ...
    implements TLongCollection {
        ...
        public boolean remove(long entry) {
            ...
            while (i2-- > 0) {
                ...
                TIntLongHashMap.this.removeAt(i2);
                return true;
            }
            return false;
        }
    ...
    implements TIntSet {
        ...
        public boolean equals(Object other) {
            ...
            int i2 = TIntLongHashMap.this._states.length;
            while (i2-- > 0) {
                if (TIntLongHashMap.this._states[i2] != 1 || that.contains(TIntLongHashMap.this._set[i2])) continue;
                return false;
            }
            return true;
        }
        ...
        public int hashCode() {
            ...
            int i2 = TIntLongHashMap.this._states.length;
            while (i2-- > 0) {
                if (TIntLongHashMap.this._states[i2] != 1) continue;
                hashcode += HashFunctions.hash(TIntLongHashMap.this._set[i2]);
            }
            return hashcode;
        }
