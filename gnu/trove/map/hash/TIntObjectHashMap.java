...
Externalizable {
    ...
    extends MapBackedView<V> {
        ...
        public boolean removeElement(V value) {
            ...
            while (i2-- > 0) {
                ...
                TIntObjectHashMap.this.removeAt(i2);
                return true;
            }
            return false;
        }
    ...
    implements TIntSet {
        ...
        public boolean equals(Object other) {
            ...
            int i2 = TIntObjectHashMap.this._states.length;
            while (i2-- > 0) {
                if (TIntObjectHashMap.this._states[i2] != 1 || that.contains(TIntObjectHashMap.this._set[i2])) continue;
                return false;
            }
            return true;
        }
        ...
        public int hashCode() {
            ...
            int i2 = TIntObjectHashMap.this._states.length;
            while (i2-- > 0) {
                if (TIntObjectHashMap.this._states[i2] != 1) continue;
                hashcode += HashFunctions.hash(TIntObjectHashMap.this._set[i2]);
            }
            return hashcode;
        }
        ...
        public String toString() {
            ...
            while (i2-- > 0) {
                ...
                buf.append(TIntObjectHashMap.this._set[i2]);
            }
            return buf.toString();
        }
