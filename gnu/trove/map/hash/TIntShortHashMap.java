...
Externalizable {
    ...
    implements TShortCollection {
        ...
        public boolean remove(short entry) {
            ...
            while (i2-- > 0) {
                ...
                TIntShortHashMap.this.removeAt(i2);
                return true;
            }
            return false;
        }
    ...
    implements TIntSet {
        ...
        public boolean equals(Object other) {
            ...
            int i2 = TIntShortHashMap.this._states.length;
            while (i2-- > 0) {
                if (TIntShortHashMap.this._states[i2] != 1 || that.contains(TIntShortHashMap.this._set[i2])) continue;
                return false;
            }
            return true;
        }
        ...
        public int hashCode() {
            ...
            int i2 = TIntShortHashMap.this._states.length;
            while (i2-- > 0) {
                if (TIntShortHashMap.this._states[i2] != 1) continue;
                hashcode += HashFunctions.hash(TIntShortHashMap.this._set[i2]);
            }
            return hashcode;
        }
