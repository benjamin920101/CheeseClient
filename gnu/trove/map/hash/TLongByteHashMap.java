...
Externalizable {
    ...
    public byte adjustOrPutValue(long key, byte adjust_amount, byte put_amount) {
        ...
        if (index < 0) {
            ...
            byte by = (byte)(this._values[n2] + adjust_amount);
            this._values[n2] = by;
            newValue = by;
            isNewMapping = false;
        } else {
    ...
    implements TByteCollection {
        ...
        public boolean remove(byte entry) {
            ...
            while (i2-- > 0) {
                ...
                TLongByteHashMap.this.removeAt(i2);
                return true;
            }
            return false;
        }
    ...
    implements TLongSet {
        ...
        public boolean equals(Object other) {
            ...
            int i2 = TLongByteHashMap.this._states.length;
            while (i2-- > 0) {
                if (TLongByteHashMap.this._states[i2] != 1 || that.contains(TLongByteHashMap.this._set[i2])) continue;
                return false;
            }
            return true;
        }
        ...
        public int hashCode() {
            ...
            int i2 = TLongByteHashMap.this._states.length;
            while (i2-- > 0) {
                if (TLongByteHashMap.this._states[i2] != 1) continue;
                hashcode += HashFunctions.hash(TLongByteHashMap.this._set[i2]);
            }
            return hashcode;
        }
