...
Externalizable {
    ...
    implements TCharCollection {
        ...
        public boolean remove(char entry) {
            ...
            while (i2-- > 0) {
                ...
                TLongCharHashMap.this.removeAt(i2);
                return true;
            }
            return false;
        }
    ...
    implements TLongSet {
        ...
        public boolean equals(Object other) {
            ...
            int i2 = TLongCharHashMap.this._states.length;
            while (i2-- > 0) {
                if (TLongCharHashMap.this._states[i2] != 1 || that.contains(TLongCharHashMap.this._set[i2])) continue;
                return false;
            }
            return true;
        }
        ...
        public int hashCode() {
            ...
            int i2 = TLongCharHashMap.this._states.length;
            while (i2-- > 0) {
                if (TLongCharHashMap.this._states[i2] != 1) continue;
                hashcode += HashFunctions.hash(TLongCharHashMap.this._set[i2]);
            }
            return hashcode;
        }
