...
Externalizable {
    ...
    implements TDoubleCollection {
        ...
        public boolean remove(double entry) {
            ...
            while (i2-- > 0) {
                ...
                TLongDoubleHashMap.this.removeAt(i2);
                return true;
            }
            return false;
        }
    ...
    implements TLongSet {
        ...
        public boolean equals(Object other) {
            ...
            int i2 = TLongDoubleHashMap.this._states.length;
            while (i2-- > 0) {
                if (TLongDoubleHashMap.this._states[i2] != 1 || that.contains(TLongDoubleHashMap.this._set[i2])) continue;
                return false;
            }
            return true;
        }
        ...
        public int hashCode() {
            ...
            int i2 = TLongDoubleHashMap.this._states.length;
            while (i2-- > 0) {
                if (TLongDoubleHashMap.this._states[i2] != 1) continue;
                hashcode += HashFunctions.hash(TLongDoubleHashMap.this._set[i2]);
            }
            return hashcode;
        }
