...
Externalizable {
    ...
    public float adjustOrPutValue(long key, float adjust_amount, float put_amount) {
        ...
        if (index < 0) {
            ...
            float f2 = this._values[n2] + adjust_amount;
            this._values[n2] = f2;
            newValue = f2;
            isNewMapping = false;
        } else {
    ...
    public void writeExternal(ObjectOutput out) throws IOException {
        ...
        while (i2-- > 0) {
            ...
            out.writeFloat(this._values[i2]);
        }
    }
    ...
    implements TFloatCollection {
        ...
        public boolean remove(float entry) {
            ...
            int i2 = values.length;
            while (i2-- > 0) {
                if (set[i2] == 0L || set[i2] == 2L || entry != values[i2]) continue;
                TLongFloatHashMap.this.removeAt(i2);
                return true;
            }
            return false;
        }
    ...
    implements TLongSet {
        ...
        public boolean equals(Object other) {
            ...
            int i2 = TLongFloatHashMap.this._states.length;
            while (i2-- > 0) {
                if (TLongFloatHashMap.this._states[i2] != 1 || that.contains(TLongFloatHashMap.this._set[i2])) continue;
                return false;
            }
            return true;
        }
        ...
        public int hashCode() {
            ...
            int i2 = TLongFloatHashMap.this._states.length;
            while (i2-- > 0) {
                if (TLongFloatHashMap.this._states[i2] != 1) continue;
                hashcode += HashFunctions.hash(TLongFloatHashMap.this._set[i2]);
            }
            return hashcode;
        }
