...
Externalizable {
    ...
    public int adjustOrPutValue(long key, int adjust_amount, int put_amount) {
        ...
        if (index < 0) {
            ...
            int n3 = this._values[n2] + adjust_amount;
            this._values[n2] = n3;
            newValue = n3;
            isNewMapping = false;
        } else {
    ...
    implements TLongSet {
        ...
        public boolean equals(Object other) {
            ...
            int i2 = TLongIntHashMap.this._states.length;
            while (i2-- > 0) {
                if (TLongIntHashMap.this._states[i2] != 1 || that.contains(TLongIntHashMap.this._set[i2])) continue;
                return false;
            }
            return true;
        }
        ...
        public int hashCode() {
            ...
            int i2 = TLongIntHashMap.this._states.length;
            while (i2-- > 0) {
                if (TLongIntHashMap.this._states[i2] != 1) continue;
                hashcode += HashFunctions.hash(TLongIntHashMap.this._set[i2]);
            }
            return hashcode;
        }
