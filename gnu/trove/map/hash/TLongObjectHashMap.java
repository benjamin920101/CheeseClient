...
Externalizable {
    ...
    public int hashCode() {
        ...
        while (i2-- > 0) {
            if (states[i2] != 1) continue;
            hashcode += HashFunctions.hash(this._set[i2]) ^ (values[i2] == null ? 0 : values[i2].hashCode());
        }
        return hashcode;
    }
    ...
    public void readExternal(ObjectInput in2) throws IOException, ClassNotFoundException {
        ...
        this.no_entry_key = in2.readLong();
    ...
    extends MapBackedView<V> {
        ...
        public boolean removeElement(V value) {
            ...
            int i2 = values.length;
            while (i2-- > 0) {
                if (states[i2] != 1 || value != values[i2] && (null == values[i2] || !values[i2].equals(value))) continue;
                TLongObjectHashMap.this.removeAt(i2);
                return true;
            }
            return false;
        }
    ...
    implements TLongSet {
        ...
        public boolean equals(Object other) {
            ...
            int i2 = TLongObjectHashMap.this._states.length;
            while (i2-- > 0) {
                if (TLongObjectHashMap.this._states[i2] != 1 || that.contains(TLongObjectHashMap.this._set[i2])) continue;
                return false;
            }
            return true;
        }
        ...
        public int hashCode() {
            ...
            int i2 = TLongObjectHashMap.this._states.length;
            while (i2-- > 0) {
                if (TLongObjectHashMap.this._states[i2] != 1) continue;
                hashcode += HashFunctions.hash(TLongObjectHashMap.this._set[i2]);
            }
            return hashcode;
        }
        ...
        public String toString() {
            ...
            while (i2-- > 0) {
                ...
                buf.append(TLongObjectHashMap.this._set[i2]);
            }
            return buf.toString();
        }
