...
Externalizable {
    ...
    implements TShortCollection {
        ...
        public boolean remove(short entry) {
            ...
            while (i2-- > 0) {
                ...
                TLongShortHashMap.this.removeAt(i2);
                return true;
            }
            return false;
        }
    ...
    implements TLongSet {
        ...
        public boolean equals(Object other) {
            ...
            int i2 = TLongShortHashMap.this._states.length;
            while (i2-- > 0) {
                if (TLongShortHashMap.this._states[i2] != 1 || that.contains(TLongShortHashMap.this._set[i2])) continue;
                return false;
            }
            return true;
        }
        ...
        public int hashCode() {
            ...
            int i2 = TLongShortHashMap.this._states.length;
            while (i2-- > 0) {
                if (TLongShortHashMap.this._states[i2] != 1) continue;
                hashcode += HashFunctions.hash(TLongShortHashMap.this._set[i2]);
            }
            return hashcode;
        }
