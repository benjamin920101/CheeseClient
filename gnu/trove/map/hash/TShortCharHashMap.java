...
Externalizable {
    ...
    implements TCharCollection {
        ...
        public boolean remove(char entry) {
            ...
            while (i2-- > 0) {
                ...
                TShortCharHashMap.this.removeAt(i2);
                return true;
            }
            return false;
        }
    ...
    implements TShortSet {
        ...
        public boolean equals(Object other) {
            ...
            int i2 = TShortCharHashMap.this._states.length;
            while (i2-- > 0) {
                if (TShortCharHashMap.this._states[i2] != 1 || that.contains(TShortCharHashMap.this._set[i2])) continue;
                return false;
            }
            return true;
        }
        ...
        public int hashCode() {
            ...
            int i2 = TShortCharHashMap.this._states.length;
            while (i2-- > 0) {
                if (TShortCharHashMap.this._states[i2] != 1) continue;
                hashcode += HashFunctions.hash(TShortCharHashMap.this._set[i2]);
            }
            return hashcode;
        }
