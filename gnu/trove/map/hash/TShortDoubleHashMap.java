...
Externalizable {
    ...
    implements TDoubleCollection {
        ...
        public boolean remove(double entry) {
            ...
            while (i2-- > 0) {
                ...
                TShortDoubleHashMap.this.removeAt(i2);
                return true;
            }
            return false;
        }
    ...
    implements TShortSet {
        ...
        public boolean equals(Object other) {
            ...
            int i2 = TShortDoubleHashMap.this._states.length;
            while (i2-- > 0) {
                if (TShortDoubleHashMap.this._states[i2] != 1 || that.contains(TShortDoubleHashMap.this._set[i2])) continue;
                return false;
            }
            return true;
        }
        ...
        public int hashCode() {
            ...
            int i2 = TShortDoubleHashMap.this._states.length;
            while (i2-- > 0) {
                if (TShortDoubleHashMap.this._states[i2] != 1) continue;
                hashcode += HashFunctions.hash(TShortDoubleHashMap.this._set[i2]);
            }
            return hashcode;
        }
