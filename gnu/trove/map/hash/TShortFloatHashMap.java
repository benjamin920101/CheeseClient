...
Externalizable {
    ...
    implements TFloatCollection {
        ...
        public boolean remove(float entry) {
            ...
            while (i2-- > 0) {
                ...
                TShortFloatHashMap.this.removeAt(i2);
                return true;
            }
            return false;
        }
    ...
    implements TShortSet {
        ...
        public boolean equals(Object other) {
            ...
            int i2 = TShortFloatHashMap.this._states.length;
            while (i2-- > 0) {
                if (TShortFloatHashMap.this._states[i2] != 1 || that.contains(TShortFloatHashMap.this._set[i2])) continue;
                return false;
            }
            return true;
        }
        ...
        public int hashCode() {
            ...
            int i2 = TShortFloatHashMap.this._states.length;
            while (i2-- > 0) {
                if (TShortFloatHashMap.this._states[i2] != 1) continue;
                hashcode += HashFunctions.hash(TShortFloatHashMap.this._set[i2]);
            }
            return hashcode;
        }
