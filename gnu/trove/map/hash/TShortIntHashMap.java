...
Externalizable {
    ...
    implements TShortSet {
        ...
        public boolean equals(Object other) {
            ...
            int i2 = TShortIntHashMap.this._states.length;
            while (i2-- > 0) {
                if (TShortIntHashMap.this._states[i2] != 1 || that.contains(TShortIntHashMap.this._set[i2])) continue;
                return false;
            }
            return true;
        }
        ...
        public int hashCode() {
            ...
            int i2 = TShortIntHashMap.this._states.length;
            while (i2-- > 0) {
                if (TShortIntHashMap.this._states[i2] != 1) continue;
                hashcode += HashFunctions.hash(TShortIntHashMap.this._set[i2]);
            }
            return hashcode;
        }
