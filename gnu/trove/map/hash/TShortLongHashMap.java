...
Externalizable {
    ...
    implements TLongCollection {
        ...
        public boolean remove(long entry) {
            ...
            int i2 = values.length;
            while (i2-- > 0) {
                if (set[i2] == 0 || set[i2] == 2 || entry != values[i2]) continue;
                TShortLongHashMap.this.removeAt(i2);
                return true;
            }
            return false;
        }
    ...
    implements TShortSet {
        ...
        public boolean equals(Object other) {
            ...
            int i2 = TShortLongHashMap.this._states.length;
            while (i2-- > 0) {
                if (TShortLongHashMap.this._states[i2] != 1 || that.contains(TShortLongHashMap.this._set[i2])) continue;
                return false;
            }
            return true;
        }
        ...
        public int hashCode() {
            ...
            int i2 = TShortLongHashMap.this._states.length;
            while (i2-- > 0) {
                if (TShortLongHashMap.this._states[i2] != 1) continue;
                hashcode += HashFunctions.hash(TShortLongHashMap.this._set[i2]);
            }
            return hashcode;
        }
