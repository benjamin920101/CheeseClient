...
public final class F {
    ...
    private static BufferedImage a(int n2, int n3, boolean bl2) {
        try {
            ...
            return ((GraphicsConfiguration)object).createCompatibleImage(n2, n3, bl2 ? 3 : 1);
        }
        catch (Throwable throwable) {
            return new BufferedImage(n2, n3, bl2 ? 2 : 1);
        }
    }
    ...
    public static BufferedImage a(URL object) {
        ...
        BufferedImage bufferedImage = F.a(0 + ((Image)object2).getWidth(null), 0 + ((Image)object2).getHeight(null), F.a((Image)object2));
    ...
    private static BufferedImage c(BufferedImage bufferedImage, float f2) {
        ...
        bufferedImage3 = F.a(bufferedImage2.getWidth(), bufferedImage3.getHeight(), bufferedImage3.getColorModel().hasAlpha());
        A a2 = new A();
        a2.a(f2);
        a2.filter(bufferedImage, bufferedImage3);
        return bufferedImage3;
    }

    public static BufferedImage a(BufferedImage bufferedImage, float f2) {
        return F.c(bufferedImage, f2);
    }
