...
public final class M {
    ...
    public final String toString() {
        ...
        if (m2.m) {
            ...
            if (((M)object).m) {
                float f2;
                float f3 = ((M)object).o << 3;
                m2 = object;
                if (m2.m) {
                    M m3 = m2;
                    double d2 = m2.l[m3.b] / (double)m2.e();
                    if (m2.g == 0 || m2.g == 2) {
                        d2 /= 2.0;
                    }
                    f2 = (float)(d2 * 1000.0);
                    ...
                    f2 = fArrayArray[m2.b - 1][m2.i];
                }
                n2 = (int)(f3 / (f2 * (float)((M)object).n)) * 1000;
            } else {
                n2 = v[((M)object).g][((M)object).b - 1][((M)object).d];
            }
            string = String.valueOf(Integer.toString(n2 / 1000)) + " kb/s";
        } else {
            string = w[m2.g][m2.b - 1][m2.d];
        }
     ...
     */
    final void a(H var1_1, r[] var2_2) {
        var5_3 = false;
        do {
            block20: {
                ...
                var4_6.t = 12 * M.v[var4_6.g][0][var4_6.d] / M.a[var4_6.g][var4_6.i];
                if (var4_6.e != 0) {
                    ++var4_6.t;
                }
                var4_6.t <<= 2;
            ...
            var4_6.t = 144 * M.v[var4_6.g][var4_6.b - 1][var4_6.d] / M.a[var4_6.g][var4_6.i];
    ...
    final void a(byte[] byArray) {
        ...
        try {
            ...
            throw new v("XingVBRHeader Corrupted", (Throwable)arrayIndexOutOfBoundsException);
        }
        String string2 = "VBRI";
        try {
            ...
            throw new v("VBRIVBRHeader Corrupted", (Throwable)arrayIndexOutOfBoundsException);
        }
    }
