...
extends MP3PlayerUI {
    ...
    protected final void a(MP3Player mP3Player) {
        ...
        BufferedImage bufferedImage = F.a(this.getClass().getResource("resources/mp3PlayerSoundOn.png"));
        BufferedImage bufferedImage2 = F.a(bufferedImage, 0.05f);
        BufferedImage bufferedImage3 = F.b(bufferedImage, 0.05f);
        BufferedImage bufferedImage4 = F.a(this.getClass().getResource("resources/mp3PlayerSoundOff.png"));
        BufferedImage bufferedImage5 = F.a(bufferedImage4, 0.05f);
        BufferedImage bufferedImage6 = F.b(bufferedImage4, 0.05f);
        this.a = new JButton();
        ...
        this.a.setIcon(p.a(bufferedImage4));
        this.a.setRolloverIcon(p.a(bufferedImage5));
        this.a.setPressedIcon(p.a(bufferedImage6));
