...
extends GenericGuildUpdateEvent<Integer> {
    ...
    public GuildUpdateBoostCountEvent(@Nonnull JDA api2, long responseNumber, @Nonnull Guild guild, int previous) {
        super(api2, responseNumber, guild, previous, guild.getBoostCount(), IDENTIFIER);
    }
