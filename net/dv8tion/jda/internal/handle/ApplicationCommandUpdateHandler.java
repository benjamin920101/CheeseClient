...
public class ApplicationCommandUpdateHandler
extends SocketHandler {
    public ApplicationCommandUpdateHandler(JDAImpl api2) {
        super(api2);
    }
    ...
    protected Long handleInternally(DataObject content) {
        ...
        this.api.handleEvent(new ApplicationCommandUpdateEvent(this.api, this.responseNumber, command, guild));
        return null;
    }
}
