...
extends GuiScreen {
    ...
    protected void actionPerformed(GuiButton button) throws IOException {
        int i2 = this.theFlatGeneratorInfo.getFlatLayers().size() - this.createFlatWorldListSlotGui.field_148228_k - 1;
        if (button.id == 1) {
    ...
    public void drawScreen(int mouseX, int mouseY, float partialTicks) {
        ...
        this.drawString(this.fontRendererObj, this.field_146394_i, i2, 32, 0xFFFFFF);
        this.drawString(this.fontRendererObj, this.field_146391_r, i2 + 2 + 213 - this.fontRendererObj.getStringWidth(this.field_146391_r), 32, 0xFFFFFF);
    ...
    extends GuiSlot {
        ...
        protected void drawSlot(int entryID, int p_180791_2_, int p_180791_3_, int p_180791_4_, int mouseXIn, int mouseYIn) {
            ...
            String string = s2 = itemstack == null ? "Air" : item.getItemStackDisplayName(itemstack);
            if (item == null) {
                ...
                if (item != null) {
                    ...
                    s2 = block.getLocalizedName();
                }
            }
            this.func_148225_a(p_180791_2_, p_180791_3_, itemstack);
            GuiCreateFlatWorld.this.fontRendererObj.drawString(s2, p_180791_2_ + 18 + 5, p_180791_3_ + 3, 0xFFFFFF);
