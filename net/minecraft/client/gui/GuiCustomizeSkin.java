...
extends GuiScreen {
    ...
    public void initGui() {
        ...
        this.buttonList.add(new GuiButtonOF(210, this.width / 2 - 100, this.height / 6 + 24 * (i2 >> 1), I18n.format("of.options.skinCustomisation.ofCape", new Object[0])));
        this.buttonList.add(new GuiButton(200, this.width / 2 - 100, this.height / 6 + 24 * ((i2 += 2) >> 1), I18n.format("gui.done", new Object[0])));
    }
    ...
    private String func_175358_a(EnumPlayerModelParts playerModelParts) {
        ...
        return String.valueOf(playerModelParts.func_179326_d().getFormattedText()) + ": " + s2;
    }
