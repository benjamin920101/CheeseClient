...
GuiPageButtonList.GuiResponder {
    ...
    private Predicate<String> field_175332_D = new Predicate<String>(){
        ...
        public boolean apply(String p_apply_1_) {
            Float f2 = Floats.tryParse(p_apply_1_);
            return p_apply_1_.length() == 0 || f2 != null && Floats.isFinite(f2.floatValue()) && f2.floatValue() >= 0.0f;
        }
    };
    ...
    public void initGui() {
        ...
        if (this.field_175349_r != null) {
            i2 = this.field_175349_r.func_178059_e();
            j2 = this.field_175349_r.getAmountScrolled();
        }
        ...
        this.func_175325_f();
        if (i2 != 0) {
            this.field_175349_r.func_181156_c(i2);
            this.field_175349_r.scrollBy(j2);
            this.func_175328_i();
        }
    }
    ...
    private void func_175325_f() {
        ...
        int i2 = 0;
        while (i2 < 4) {
            this.field_175342_h[i2] = I18n.format("createWorld.customize.custom.page" + i2, new Object[0]);
            ++i2;
        }
        this.func_175328_i();
    }
    ...
    public void func_175319_a(int p_175319_1_, String p_175319_2_) {
        float f2 = 0.0f;
        try {
            f2 = Float.parseFloat(p_175319_2_);
        }
        ...
        switch (p_175319_1_) {
            case 132: {
                f1 = this.field_175336_F.mainNoiseScaleX = MathHelper.clamp_float(f2, 1.0f, 5000.0f);
                break;
            }
            case 133: {
                f1 = this.field_175336_F.mainNoiseScaleY = MathHelper.clamp_float(f2, 1.0f, 5000.0f);
                break;
            }
            case 134: {
                f1 = this.field_175336_F.mainNoiseScaleZ = MathHelper.clamp_float(f2, 1.0f, 5000.0f);
                break;
            }
            case 135: {
                f1 = this.field_175336_F.depthNoiseScaleX = MathHelper.clamp_float(f2, 1.0f, 2000.0f);
                break;
            }
            case 136: {
                f1 = this.field_175336_F.depthNoiseScaleZ = MathHelper.clamp_float(f2, 1.0f, 2000.0f);
                break;
            }
            case 137: {
                f1 = this.field_175336_F.depthNoiseScaleExponent = MathHelper.clamp_float(f2, 0.01f, 20.0f);
                break;
            }
            case 138: {
                f1 = this.field_175336_F.baseSize = MathHelper.clamp_float(f2, 1.0f, 25.0f);
                break;
            }
            case 139: {
                f1 = this.field_175336_F.coordinateScale = MathHelper.clamp_float(f2, 1.0f, 6000.0f);
                break;
            }
            case 140: {
                f1 = this.field_175336_F.heightScale = MathHelper.clamp_float(f2, 1.0f, 6000.0f);
                break;
            }
            case 141: {
                f1 = this.field_175336_F.stretchY = MathHelper.clamp_float(f2, 0.01f, 50.0f);
                break;
            }
            case 142: {
                f1 = this.field_175336_F.upperLimitScale = MathHelper.clamp_float(f2, 1.0f, 5000.0f);
                break;
            }
            case 143: {
                f1 = this.field_175336_F.lowerLimitScale = MathHelper.clamp_float(f2, 1.0f, 5000.0f);
                break;
            }
            case 144: {
                f1 = this.field_175336_F.biomeDepthWeight = MathHelper.clamp_float(f2, 1.0f, 20.0f);
                break;
            }
            case 145: {
                f1 = this.field_175336_F.biomeDepthOffset = MathHelper.clamp_float(f2, 0.0f, 20.0f);
                break;
            }
            case 146: {
                f1 = this.field_175336_F.biomeScaleWeight = MathHelper.clamp_float(f2, 1.0f, 20.0f);
                break;
            }
            case 147: {
                f1 = this.field_175336_F.biomeScaleOffset = MathHelper.clamp_float(f2, 0.0f, 20.0f);
            }
        }
        if (f1 != f2 && f2 != 0.0f) {
    ...
    @Override
    public String getText(int id2, String name, float value) {
        return String.valueOf(name) + ": " + this.func_175330_b(id2, value);
    }
    ...
    @Override
    public void onTick(int id2, float value) {
        Gui gui;
        switch (id2) {
            case 100: {
        ...
        if (id2 >= 100 && id2 < 116 && (gui = this.field_175349_r.func_178061_c(id2 - 100 + 132)) != null) {
            ((GuiTextField)gui).setText(this.func_175330_b(id2, value));
        }
        if (!this.field_175336_F.equals(this.field_175334_E)) {
            this.func_181031_a(true);
        }
    ...
    protected void actionPerformed(GuiButton button) throws IOException {
        if (button.enabled) {
            switch (button.id) {
                ...
                case 301: {
                    int i2 = 0;
                    while (i2 < this.field_175349_r.getSize()) {
                        Gui gui1;
                        GuiPageButtonList.GuiEntry guipagebuttonlist$guientry = this.field_175349_r.getListEntry(i2);
                        Gui gui = guipagebuttonlist$guientry.func_178022_a();
                        if (gui instanceof GuiButton) {
                            GuiButton guibutton = (GuiButton)gui;
                            if (guibutton instanceof GuiSlider) {
                                float f2 = ((GuiSlider)guibutton).func_175217_d() * (0.75f + this.random.nextFloat() * 0.5f) + (this.random.nextFloat() * 0.1f - 0.05f);
                                ((GuiSlider)guibutton).func_175219_a(MathHelper.clamp_float(f2, 0.0f, 1.0f));
    ...
    private void func_175327_a(float p_175327_1_) {
        ...
        if (gui instanceof GuiTextField) {
            ...
            if (GuiScreen.isShiftKeyDown()) {
                ...
                f2 = p_175327_1_ * 10.0f;
                if (GuiScreen.isAltKeyDown()) {
                    f2 *= 10.0f;
                }
            }
            if ((f1 = Floats.tryParse((guitextfield = (GuiTextField)gui).getText())) != null) {
                f1 = Float.valueOf(f1.floatValue() + f2);
                int i2 = guitextfield.getId();
                String s2 = this.func_175330_b(guitextfield.getId(), f1.floatValue());
                guitextfield.setText(s2);
                this.func_175319_a(i2, s2);
            }
        }
    }
