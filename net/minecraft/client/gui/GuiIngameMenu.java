...
extends GuiScreen {
    ...
    public void initGui() {
        ...
        this.buttonList.add(new GuiButton(5, this.width / 2 - 100, this.height / 4 + 48 + i2, 98, 20, I18n.format("gui.achievements", new Object[0])));
        this.buttonList.add(new GuiButton(6, this.width / 2 + 2, this.height / 4 + 48 + i2, 98, 20, I18n.format("gui.stats", new Object[0])));
