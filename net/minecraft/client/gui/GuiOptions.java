    ...
    public void initGui() {
        ...
        while (n3 < n2) {
            ...
            if (gamesettings$options.getEnumFloat()) {
                this.buttonList.add(new GuiOptionSlider(gamesettings$options.returnEnumOrdinal(), this.width / 2 - 155 + i2 % 2 * 160, this.height / 6 - 12 + 24 * (i2 >> 1), gamesettings$options));
            } else {
                GuiOptionButton guioptionbutton = new GuiOptionButton(gamesettings$options.returnEnumOrdinal(), this.width / 2 - 155 + i2 % 2 * 160, this.height / 6 - 12 + 24 * (i2 >> 1), gamesettings$options, this.game_settings_1.getKeyBinding(gamesettings$options));
        ...
        if (this.mc.theWorld != null) {
            ...
            this.field_175357_i = new GuiButton(108, this.width / 2 - 155 + i2 % 2 * 160, this.height / 6 - 12 + 24 * (i2 >> 1), 150, 20, this.func_175355_a(enumdifficulty));
            ...
            GuiOptionButton guioptionbutton1 = new GuiOptionButton(GameSettings.Options.REALMS_NOTIFICATIONS.returnEnumOrdinal(), this.width / 2 - 155 + i2 % 2 * 160, this.height / 6 - 12 + 24 * (i2 >> 1), GameSettings.Options.REALMS_NOTIFICATIONS, this.game_settings_1.getKeyBinding(GameSettings.Options.REALMS_NOTIFICATIONS));
