...
extends GuiScreen {
    ...
    extends GuiSlot {
        ...
        private void func_178051_a(int p_178051_1_, int p_178051_2_, ResourceLocation p_178051_3_) {
            int i2 = p_178051_1_ + 5;
            GuiScreenCustomizePresets.this.drawHorizontalLine(i2 - 1, i2 + 32, p_178051_2_ - 1, -2039584);
            GuiScreenCustomizePresets.this.drawHorizontalLine(i2 - 1, i2 + 32, p_178051_2_ + 32, -6250336);
            GuiScreenCustomizePresets.this.drawVerticalLine(i2 - 1, p_178051_2_ - 1, p_178051_2_ + 32, -2039584);
            GuiScreenCustomizePresets.this.drawVerticalLine(i2 + 32, p_178051_2_ - 1, p_178051_2_ + 32, -6250336);
            ...
            worldrenderer.pos(i2 + 0, p_178051_2_ + 32, 0.0).tex(0.0, 1.0).endVertex();
            worldrenderer.pos(i2 + 32, p_178051_2_ + 32, 0.0).tex(1.0, 1.0).endVertex();
            worldrenderer.pos(i2 + 32, p_178051_2_ + 0, 0.0).tex(1.0, 0.0).endVertex();
            worldrenderer.pos(i2 + 0, p_178051_2_ + 0, 0.0).tex(0.0, 0.0).endVertex();
            tessellator.draw();
        }
