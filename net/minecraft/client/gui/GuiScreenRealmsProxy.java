...
extends GuiScreen {
    ...
    public void drawTexturedModalRect(int x2, int y2, int textureX, int textureY, int width, int height) {
        this.field_154330_a.blit(x2, y2, textureX, textureY, width, height);
        super.drawTexturedModalRect(x2, y2, textureX, textureY, width, height);
    }
    ...
    @Override
    public void renderToolTip(ItemStack stack, int x2, int y2) {
    ...
    public void drawHoveringText(List<String> textLines, int x2, int y2) {
        super.drawHoveringText(textLines, x2, y2);
    }
    ...
    public void confirmClicked(boolean result, int id2) {
        this.field_154330_a.confirmResult(result, id2);
    }
