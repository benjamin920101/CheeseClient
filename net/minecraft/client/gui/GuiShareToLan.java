...
extends GuiScreen {
    ...
    protected void actionPerformed(GuiButton button) throws IOException {
        if (button.id == 102) {
            ...
            String s2 = this.mc.getIntegratedServer().shareToLAN(WorldSettings.GameType.getByName(this.field_146599_h), this.field_146600_i);
            ChatComponentStyle ichatcomponent = s2 != null ? new ChatComponentTranslation("commands.publish.started", s2) : new ChatComponentText("commands.publish.failed");
