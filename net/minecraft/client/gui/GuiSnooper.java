...
extends GuiScreen {
    ...
    public void initGui() {
        ...
        for (String s1 : this.fontRendererObj.listFormattedStringToWidth(s2, this.width - 30)) {
            list.add(s1);
        }
    ...
    public void drawScreen(int mouseX, int mouseY, float partialTicks) {
        ...
        int n2 = this.field_146607_r.length;
        int n3 = 0;
        while (n3 < n2) {
            String s2 = stringArray[n3];
            this.drawCenteredString(this.fontRendererObj, s2, this.width / 2, i2, 0x808080);
