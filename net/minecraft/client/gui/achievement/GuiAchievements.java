...
implements IProgressMeter {
    ...
    protected void drawAchievementScreen(int p_146552_1_, int p_146552_2_, float p_146552_3_) {
        ...
        int j5 = 0;
        while (j5 < AchievementList.achievementList.size()) {
        ...
        GlStateManager.enableColorMaterial();
        int i6 = 0;
        while (i6 < AchievementList.achievementList.size()) {
            block50: {
                int j7;
                int l6;
                ...
                block52: {
                    ...
                    block55: {
                        block54: {
                            block53: {
                                block51: {
                                    achievement2 = AchievementList.achievementList.get(i6);
                                    l6 = achievement2.displayColumn * 24 - i2;
                                    j7 = achievement2.displayRow * 24 - j2;
                                    if (l6 < -24 || j7 < -24 || !((float)l6 <= 224.0f * this.field_146570_r) || !((float)j7 <= 155.0f * this.field_146570_r)) break block50;
