...
implements IProgressMeter {
    ...
    extends GuiSlot {
        ...
        protected void drawListHeader(int p_148129_1_, int p_148129_2_, Tessellator p_148129_3_) {
            ...
            if (this.field_148217_o != -1) {
                ...
                GuiStats.this.drawSprite(p_148129_1_ + i2, p_148129_2_ + 1, j2, 0);
            }
        }
        ...
        protected void func_148209_a(StatBase p_148209_1_, int p_148209_2_, int p_148209_3_, boolean p_148209_4_) {
            if (p_148209_1_ != null) {
                String s2 = p_148209_1_.format(GuiStats.this.field_146546_t.readStat(p_148209_1_));
                GuiStats.this.drawString(GuiStats.this.fontRendererObj, s2, p_148209_2_ - GuiStats.this.fontRendererObj.getStringWidth(s2), p_148209_3_ + 5, p_148209_4_ ? 0xFFFFFF : 0x909090);
            } else {
                String s1 = "-";
        ...
        protected void func_148142_b(int p_148142_1_, int p_148142_2_) {
            if (p_148142_2_ >= this.top && p_148142_2_ <= this.bottom) {
                int i2 = this.getSlotIndexFromScreenCoords(p_148142_1_, p_148142_2_);
                int j2 = this.width / 2 - 92 - 16;
                if (i2 >= 0) {
                    if (p_148142_1_ < j2 + 40 || p_148142_1_ > j2 + 40 + 20) {
                        return;
                    }
                    StatCrafting statcrafting = this.func_148211_c(i2);
                    this.func_148213_a(statcrafting, p_148142_1_, p_148142_2_);
                } else {
                    String s2 = "";
                    if (p_148142_1_ >= j2 + 115 - 18 && p_148142_1_ <= j2 + 115) {
                        s2 = this.func_148210_b(0);
                    } else if (p_148142_1_ >= j2 + 165 - 18 && p_148142_1_ <= j2 + 165) {
                        s2 = this.func_148210_b(1);
                    } else {
                        if (p_148142_1_ < j2 + 215 - 18 || p_148142_1_ > j2 + 215) {
                            return;
                        }
                        s2 = this.func_148210_b(2);
                    }
                    s2 = I18n.format(s2, new Object[0]).trim();
                    if (s2.length() > 0) {
                        int k2 = p_148142_1_ + 12;
                        int l2 = p_148142_2_ - 12;
                        int i1 = GuiStats.this.fontRendererObj.getStringWidth(s2);
                        GuiStats.this.drawGradientRect(k2 - 3, l2 - 3, k2 + i1 + 3, l2 + 8 + 3, -1073741824, -1073741824);
                        GuiStats.this.fontRendererObj.drawStringWithShadow(s2, k2, l2, -1);
                    }
                }
            }
        }
        ...
        protected void func_148213_a(StatCrafting p_148213_1_, int p_148213_2_, int p_148213_3_) {
            ...
            String s2;
            String s1;
            if (p_148213_1_ != null && (s1 = I18n.format(String.valueOf(s2 = (itemstack = new ItemStack(item = p_148213_1_.func_150959_a())).getUnlocalizedName()) + ".name", new Object[0]).trim()).length() > 0) {
                int i2 = p_148213_2_ + 12;
                int j2 = p_148213_3_ - 12;
                int k2 = GuiStats.this.fontRendererObj.getStringWidth(s1);
                GuiStats.this.drawGradientRect(i2 - 3, j2 - 3, i2 + k2 + 3, j2 + 8 + 3, -1073741824, -1073741824);
                GuiStats.this.fontRendererObj.drawStringWithShadow(s1, i2, j2, -1);
            }
        }
    ...
    extends Stats {
        public StatsBlock(Minecraft mcIn) {
            ...
            for (StatCrafting statcrafting : StatList.objectMineStats) {
                boolean flag = false;
                int i2 = Item.getIdFromItem(statcrafting.func_150959_a());
                if (GuiStats.this.field_146546_t.readStat(statcrafting) > 0) {
                    flag = true;
                } else if (StatList.objectUseStats[i2] != null && GuiStats.this.field_146546_t.readStat(StatList.objectUseStats[i2]) > 0) {
                    flag = true;
                } else if (StatList.objectCraftStats[i2] != null && GuiStats.this.field_146546_t.readStat(StatList.objectCraftStats[i2]) > 0) {
                    flag = true;
                }
                if (!flag) continue;
            ...
            this.statSorter = new Comparator<StatCrafting>(){
                ...
                public int compare(StatCrafting p_compare_1_, StatCrafting p_compare_2_) {
                    int j2 = Item.getIdFromItem(p_compare_1_.func_150959_a());
                    int k2 = Item.getIdFromItem(p_compare_2_.func_150959_a());
                    StatBase statbase = null;
                    StatBase statbase1 = null;
                    if (StatsBlock.this.field_148217_o == 2) {
                        statbase = StatList.mineBlockStatArray[j2];
                        statbase1 = StatList.mineBlockStatArray[k2];
                    } else if (StatsBlock.this.field_148217_o == 0) {
                        statbase = StatList.objectCraftStats[j2];
                        statbase1 = StatList.objectCraftStats[k2];
                    } else if (StatsBlock.this.field_148217_o == 1) {
                        statbase = StatList.objectUseStats[j2];
                        statbase1 = StatList.objectUseStats[k2];
                    }
                    if (statbase != null || statbase1 != null) {
                        ...
                        int l2 = GuiStats.this.field_146546_t.readStat(statbase);
                        if (l2 != (i1 = GuiStats.this.field_146546_t.readStat(statbase1))) {
                            return (l2 - i1) * StatsBlock.this.field_148215_p;
                        }
                    }
                    return j2 - k2;
                }
        ...
        protected void drawSlot(int entryID, int p_180791_2_, int p_180791_3_, int p_180791_4_, int mouseXIn, int mouseYIn) {
            ...
            this.func_148209_a(StatList.objectCraftStats[i2], p_180791_2_ + 115, p_180791_3_, entryID % 2 == 0);
            this.func_148209_a(StatList.objectUseStats[i2], p_180791_2_ + 165, p_180791_3_, entryID % 2 == 0);
    ...
    extends GuiSlot {
        ...
        protected void drawSlot(int entryID, int p_180791_2_, int p_180791_3_, int p_180791_4_, int mouseXIn, int mouseYIn) {
            ...
            String s2 = statbase.format(GuiStats.this.field_146546_t.readStat(statbase));
            GuiStats.this.drawString(GuiStats.this.fontRendererObj, s2, p_180791_2_ + 2 + 213 - GuiStats.this.fontRendererObj.getStringWidth(s2), p_180791_3_ + 1, entryID % 2 == 0 ? 0xFFFFFF : 0x909090);
        }
    }
    ...
    extends Stats {
        public StatsItem(Minecraft mcIn) {
            ...
            for (StatCrafting statcrafting : StatList.itemStats) {
                ...
                if (GuiStats.this.field_146546_t.readStat(statcrafting) > 0) {
                    flag = true;
                } else if (StatList.objectBreakStats[i2] != null && GuiStats.this.field_146546_t.readStat(StatList.objectBreakStats[i2]) > 0) {
                    flag = true;
                } else if (StatList.objectCraftStats[i2] != null && GuiStats.this.field_146546_t.readStat(StatList.objectCraftStats[i2]) > 0) {
                    flag = true;
                }
            ...
            this.statSorter = new Comparator<StatCrafting>(){
                ...
                public int compare(StatCrafting p_compare_1_, StatCrafting p_compare_2_) {
                    ...
                    if (StatsItem.this.field_148217_o == 0) {
                        statbase = StatList.objectBreakStats[j2];
                        statbase1 = StatList.objectBreakStats[k2];
                    ...
                    if (statbase != null || statbase1 != null) {
                        ...
                        int l2 = GuiStats.this.field_146546_t.readStat(statbase);
                        if (l2 != (i1 = GuiStats.this.field_146546_t.readStat(statbase1))) {
                            return (l2 - i1) * StatsItem.this.field_148215_p;
                        }
                    }
                    return j2 - k2;
                }
        ...
        protected void drawSlot(int entryID, int p_180791_2_, int p_180791_3_, int p_180791_4_, int mouseXIn, int mouseYIn) {
            ...
            GuiStats.this.drawStatsScreen(p_180791_2_ + 40, p_180791_3_, item);
            int i2 = Item.getIdFromItem(item);
            this.func_148209_a(StatList.objectBreakStats[i2], p_180791_2_ + 115, p_180791_3_, entryID % 2 == 0);
            this.func_148209_a(StatList.objectCraftStats[i2], p_180791_2_ + 165, p_180791_3_, entryID % 2 == 0);
            this.func_148209_a(statcrafting, p_180791_2_ + 215, p_180791_3_, entryID % 2 == 0);
        }
    ...
    extends GuiSlot {
        ...
        protected void drawSlot(int entryID, int p_180791_2_, int p_180791_3_, int p_180791_4_, int mouseXIn, int mouseYIn) {
            ...
            String s2 = I18n.format("entity." + EntityList.getStringFromID(entitylist$entityegginfo.spawnedID) + ".name", new Object[0]);
            int i2 = GuiStats.this.field_146546_t.readStat(entitylist$entityegginfo.field_151512_d);
            int j2 = GuiStats.this.field_146546_t.readStat(entitylist$entityegginfo.field_151513_e);
            String s1 = I18n.format("stat.entityKills", i2, s2);
            String s22 = I18n.format("stat.entityKilledBy", s2, j2);
            if (i2 == 0) {
                s1 = I18n.format("stat.entityKills.none", s2);
            }
            if (j2 == 0) {
                s22 = I18n.format("stat.entityKilledBy.none", s2);
            }
            GuiStats.this.drawString(GuiStats.this.fontRendererObj, s2, p_180791_2_ + 2 - 10, p_180791_3_ + 1, 0xFFFFFF);
            GuiStats.this.drawString(GuiStats.this.fontRendererObj, s1, p_180791_2_ + 2, p_180791_3_ + 1 + ((GuiStats)GuiStats.this).fontRendererObj.FONT_HEIGHT, i2 == 0 ? 0x606060 : 0x909090);
            GuiStats.this.drawString(GuiStats.this.fontRendererObj, s22, p_180791_2_ + 2, p_180791_3_ + 1 + ((GuiStats)GuiStats.this).fontRendererObj.FONT_HEIGHT * 2, j2 == 0 ? 0x606060 : 0x909090);
        }
    }
}
