...
extends GuiScreen {
    ...
    extends GuiSlot {
        ...
        protected void drawSlot(int entryID, int p_180791_2_, int p_180791_3_, int p_180791_4_, int mouseXIn, int mouseYIn) {
            ...
            String s2 = ingestserver.serverUrl.replaceAll("\\{stream_key\\}", "");
            ...
            if (this.isSelected(entryID)) {
                s22 = (Object)((Object)EnumChatFormatting.BLUE) + "(Preferred)";
            } else if (ingestserver.defaultServer) {
                s22 = (Object)((Object)EnumChatFormatting.GREEN) + "(Default)";
            }
            ...
            GuiIngestServers.this.drawString(GuiIngestServers.this.fontRendererObj, s2, p_180791_2_ + 2, p_180791_3_ + ((GuiIngestServers)GuiIngestServers.this).fontRendererObj.FONT_HEIGHT + 5 + 3, 0x303030);
            ...
            if (s22 != null) {
                GuiIngestServers.this.drawString(GuiIngestServers.this.fontRendererObj, s22, this.getScrollBarX() - 5 - GuiIngestServers.this.fontRendererObj.getStringWidth(s22), p_180791_3_ + 5 + 3 + ((GuiIngestServers)GuiIngestServers.this).fontRendererObj.FONT_HEIGHT, 0x808080);
            }
        }
