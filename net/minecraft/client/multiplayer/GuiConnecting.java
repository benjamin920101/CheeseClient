...
extends GuiScreen {
    ...
    private void connect(final String ip2, final int port) {
        logger.info("Connecting to " + ip2 + ", " + port);
        new Thread("Server Connector #" + CONNECTION_ID.incrementAndGet()){
            ...
            public void run() {
                ...
                try {
                    ...
                    GuiConnecting.this.networkManager.sendPacket(new C00Handshake(47, ip2, port, EnumConnectionState.LOGIN));
                    ...
                    GuiConnecting.this.mc.displayGuiScreen(new GuiDisconnected(GuiConnecting.this.previousGuiScreen, "connect.failed", new ChatComponentTranslation("disconnect.genericReason", s2)));
                }
            }
        }.start();
    }
