...
implements Comparable<KeyBinding> {
    ...
    public int compareTo(KeyBinding p_compareTo_1_) {
        int i2 = I18n.format(this.keyCategory, new Object[0]).compareTo(I18n.format(p_compareTo_1_.keyCategory, new Object[0]));
        if (i2 == 0) {
            i2 = I18n.format(this.keyDescription, new Object[0]).compareTo(I18n.format(p_compareTo_1_.keyDescription, new Object[0]));
        }
        return i2;
    }
}
