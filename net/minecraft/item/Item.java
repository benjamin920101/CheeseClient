...
public class Item {
    ...
    public static Item getItemById(int id2) {
        return itemRegistry.getObjectById(id2);
    }
    ...
    public static Item getByNameOrId(String id2) {
        Item item = itemRegistry.getObject(new ResourceLocation(id2));
        if (item == null) {
            try {
                return Item.getItemById(Integer.parseInt(id2));
            }
    ...
    public String getUnlocalizedNameInefficiently(ItemStack stack) {
        String s2 = this.getUnlocalizedName(stack);
        return s2 == null ? "" : StatCollector.translateToLocal(s2);
    }
    ...
    public String getItemStackDisplayName(ItemStack stack) {
        return StatCollector.translateToLocal(String.valueOf(this.getUnlocalizedNameInefficiently(stack)) + ".name").trim();
    }
    ...
    protected MovingObjectPosition getMovingObjectPositionFromPlayer(World worldIn, EntityPlayer playerIn, boolean useLiquids) {
        float f2 = playerIn.rotationPitch;
    ...
    private static void registerItem(int id2, String textualID, Item itemIn) {
        Item.registerItem(id2, new ResourceLocation(textualID), itemIn);
    }

    private static void registerItem(int id2, ResourceLocation textualID, Item itemIn) {
        itemRegistry.register(id2, textualID, itemIn);
    }
