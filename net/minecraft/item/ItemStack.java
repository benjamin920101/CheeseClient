...
public final class ItemStack {
    ...
    public boolean attemptDamageItem(int amount, Random rand) {
        ...
        if (amount > 0) {
            int i2 = EnchantmentHelper.getEnchantmentLevel(Enchantment.unbreaking.effectId, this);
            int j2 = 0;
            int k2 = 0;
            while (i2 > 0 && k2 < amount) {
                if (EnchantmentDurability.negateDamage(this, i2, rand)) {
                    ++j2;
                }
                ++k2;
            }
    ...
    public String getDisplayName() {
        ...
        String s2 = this.getItem().getItemStackDisplayName(this);
        if (this.stackTagCompound != null && this.stackTagCompound.hasKey("display", 10) && (nbttagcompound = this.stackTagCompound.getCompoundTag("display")).hasKey("Name", 8)) {
            s2 = nbttagcompound.getString("Name");
        }
        return s2;
    }
    ...
    public List<String> getTooltip(EntityPlayer playerIn, boolean advanced) {
        ...
        String s2 = this.getDisplayName();
        if (this.hasDisplayName()) {
            s2 = (Object)((Object)EnumChatFormatting.ITALIC) + s2;
        }
        s2 = String.valueOf(s2) + (Object)((Object)EnumChatFormatting.RESET);
        if (advanced) {
            String s1 = "";
            if (s2.length() > 0) {
            ...
            int i2 = Item.getIdFromItem(this.item);
            s2 = this.getHasSubtypes() ? String.valueOf(s2) + String.format("#%04d/%d%s", i2, this.itemDamage, s1) : String.valueOf(s2) + String.format("#%04d%s", i2, s1);
        ...
        if (this.hasTagCompound()) {
            ...
            if ((i1 & 1) == 0 && (nbttaglist = this.getEnchantmentTagList()) != null) {
                int j2 = 0;
                while (j2 < nbttaglist.tagCount()) {
                    short k2 = nbttaglist.getCompoundTagAt(j2).getShort("id");
                    short l2 = nbttaglist.getCompoundTagAt(j2).getShort("lvl");
                    if (Enchantment.getEnchantmentById(k2) != null) {
                        list.add(Enchantment.getEnchantmentById(k2).getTranslatedName(l2));
                    }
                    ++j2;
                }
            }
    ...
    public boolean canDestroy(Block blockIn) {
        ...
        if (this.hasTagCompound() && this.stackTagCompound.hasKey("CanDestroy", 9)) {
            ...
            int i2 = 0;
            while (i2 < nbttaglist.tagCount()) {
                Block block = Block.getBlockFromName(nbttaglist.getStringTagAt(i2));
                if (block == blockIn) {
