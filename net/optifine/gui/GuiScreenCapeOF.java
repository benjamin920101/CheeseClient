...
extends GuiScreenOF {
    ...
    public void initGui() {
        ...
        this.buttonList.add(new GuiButtonOF(210, this.width / 2 - 155, this.height / 6 + 24 * ((i2 += 2) >> 1), 150, 20, I18n.format("of.options.capeOF.openEditor", new Object[0])));
        this.buttonList.add(new GuiButtonOF(220, this.width / 2 - 155 + 160, this.height / 6 + 24 * (i2 >> 1), 150, 20, I18n.format("of.options.capeOF.reloadCape", new Object[0])));
        this.buttonCopyLink = new GuiButtonOF(230, this.width / 2 - 100, this.height / 6 + 24 * ((i2 += 6) >> 1), 200, 20, I18n.format("of.options.capeOF.copyEditorLink", new Object[0]));
        this.buttonCopyLink.visible = this.linkUrl != null;
        this.buttonList.add(this.buttonCopyLink);
        this.buttonList.add(new GuiButtonOF(200, this.width / 2 - 100, this.height / 6 + 24 * ((i2 += 4) >> 1), I18n.format("gui.done", new Object[0])));
    }
    ...
    protected void actionPerformed(GuiButton button) {
        if (button.enabled) {
            ...
            if (button.id == 210) {
                try {
                    String s2 = this.mc.getSession().getProfile().getName();
                    String s1 = this.mc.getSession().getProfile().getId().toString().replace("-", "");
                    String s22 = this.mc.getSession().getToken();
                    ...
                    this.mc.getSessionService().joinServer(this.mc.getSession().getProfile(), s22, s3);
                    String s4 = "https://optifine.net/capeChange?u=" + s1 + "&n=" + s2 + "&s=" + s3;
            ...
            if (button.id == 220) {
                ...
                if (this.mc.thePlayer != null) {
                    long i2 = 15000L;
                    long j2 = System.currentTimeMillis() + i2;
                    this.mc.thePlayer.setReloadCapeTimeMs(j2);
                }
            }
