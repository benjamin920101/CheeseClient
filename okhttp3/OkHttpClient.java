...
WebSocket.Factory {
    ...
    OkHttpClient(Builder builder) {
        ...
        if (builder.sslSocketFactory != null || !isTLS) {
            ...
            this.sslSocketFactory = OkHttpClient.newSslSocketFactory(trustManager);
    ...
    static {
        Internal.instance = new Internal(){
            ...
            @Override
            public boolean equalsNonHost(Address a2, Address b2) {
                return a2.equalsNonHost(b2);
            }
            ...
            @Override
            public boolean isInvalidHttpUrlHost(IllegalArgumentException e2) {
                return e2.getMessage().startsWith("Invalid URL host");
            }
            ...
            @Override
            @Nullable
            public IOException timeoutExit(Call call, @Nullable IOException e2) {
                return ((RealCall)call).timeoutExit(e2);
            }
    ...
    public static final class Builder {
        ...
        public Builder protocols(List<Protocol> protocols) {
            if (!(protocols = new ArrayList<Protocol>(protocols)).contains((Object)Protocol.H2_PRIOR_KNOWLEDGE) && !protocols.contains((Object)Protocol.HTTP_1_1)) {
                throw new IllegalArgumentException("protocols must contain h2_prior_knowledge or http/1.1: " + protocols);
            }
            if (protocols.contains((Object)Protocol.H2_PRIOR_KNOWLEDGE) && protocols.size() > 1) {
                throw new IllegalArgumentException("protocols containing h2_prior_knowledge cannot use other protocols: " + protocols);
            }
            if (protocols.contains((Object)Protocol.HTTP_1_0)) {
                throw new IllegalArgumentException("protocols must not contain http/1.0: " + protocols);
            }
            if (protocols.contains(null)) {
                throw new IllegalArgumentException("protocols must not contain null");
            }
            protocols.remove((Object)Protocol.SPDY_3);
