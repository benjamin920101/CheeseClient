...
implements HttpCodec {
    ...
    public static List<Header> http2HeadersList(Request request) {
        ...
        for (int i2 = 0; i2 < size; ++i2) {
            String name = headers.name(i2).toLowerCase(Locale.US);
            if (HTTP_2_SKIPPED_REQUEST_HEADERS.contains(name) && (!name.equals(TE) || !headers.value(i2).equals("trailers"))) continue;
