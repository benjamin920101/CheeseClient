...
public class CollectionUtils {
    ...
    public static <O> Collection<O> union(Iterable<? extends O> a2, Iterable<? extends O> b2) {
        SetOperationCardinalityHelper<O> helper = new SetOperationCardinalityHelper<O>(a2, b2);
        for (O obj : helper) {
    ...
    public static <O> Collection<O> intersection(Iterable<? extends O> a2, Iterable<? extends O> b2) {
        SetOperationCardinalityHelper<O> helper = new SetOperationCardinalityHelper<O>(a2, b2);
        for (O obj : helper) {
    ...
    public static <O> Collection<O> disjunction(Iterable<? extends O> a2, Iterable<? extends O> b2) {
        SetOperationCardinalityHelper<O> helper = new SetOperationCardinalityHelper<O>(a2, b2);
        for (O obj : helper) {
    ...
    public static <O> Collection<O> subtract(Iterable<? extends O> a2, Iterable<? extends O> b2) {
        Predicate p2 = TruePredicate.truePredicate();
        return CollectionUtils.subtract(a2, b2, p2);
    }

    public static <O> Collection<O> subtract(Iterable<? extends O> a2, Iterable<? extends O> b2, Predicate<O> p2) {
        ArrayList<O> list = new ArrayList<O>();
        HashBag<O> bag2 = new HashBag<O>();
        for (O element : b2) {
            if (!p2.evaluate(element)) continue;
            bag2.add(element);
        }
        for (O element : a2) {
            if (bag2.remove(element, 1)) continue;
            list.add(element);
        }
        return list;
    }
    ...
    public static boolean containsAll(Collection<?> coll1, Collection<?> coll2) {
        ...
        for (Object nextElement : coll2) {
            ...
            while (it2.hasNext()) {
                Object p2 = it2.next();
                elementsAlreadySeen.add(p2);
                if (!(nextElement == null ? p2 == null : nextElement.equals(p2))) continue;
    ...
    public static boolean isSubCollection(Collection<?> a2, Collection<?> b2) {
        CardinalityHelper helper = new CardinalityHelper(a2, b2);
        for (Object obj : a2) {
    ...
    public static <E> boolean isEqualCollection(Collection<? extends E> a2, Collection<? extends E> b2, final Equator<? super E> equator) {
        if (equator == null) {
        ...
        return CollectionUtils.isEqualCollection(CollectionUtils.collect(a2, transformer), CollectionUtils.collect(b2, transformer));
    }
    ...
    public static <T> boolean filter(Iterable<T> collection, Predicate<? super T> predicate) {
        ...
        if (collection != null && predicate != null) {
            ...
            while (it2.hasNext()) {
                if (predicate.evaluate(it2.next())) continue;
                it2.remove();
                result = true;
            }
        }
    ...
    public static <C> void transform(Collection<C> collection, Transformer<? super C, ? extends C> transformer) {
        if (collection != null && transformer != null) {
            if (collection instanceof List) {
                ...
                ListIterator<C> it2 = list.listIterator();
                while (it2.hasNext()) {
                    it2.set(transformer.transform(it2.next()));
                }
            } else {
    ...
    public static Object get(Object object, int index) {
        ...
        if (object instanceof Map) {
            ...
            return IteratorUtils.get(iterator, i2);
        }
        if (object instanceof Object[]) {
            return ((Object[])object)[i2];
        }
        if (object instanceof Iterator) {
            Iterator it2 = (Iterator)object;
            return IteratorUtils.get(it2, i2);
        }
        if (object instanceof Iterable) {
            Iterable iterable = (Iterable)object;
            return IterableUtils.get(iterable, i2);
        }
        ...
        if (object instanceof Enumeration) {
            Enumeration it3 = (Enumeration)object;
            return EnumerationUtils.get(it3, i2);
        }
        if (object == null) {
            throw new IllegalArgumentException("Unsupported object type: null");
        }
        try {
            return Array.get(object, i2);
        }
    ...
    public static <O extends Comparable<? super O>> List<O> collate(Iterable<? extends O> a2, Iterable<? extends O> b2) {
        return CollectionUtils.collate(a2, b2, ComparatorUtils.naturalComparator(), true);
    }

    public static <O extends Comparable<? super O>> List<O> collate(Iterable<? extends O> a2, Iterable<? extends O> b2, boolean includeDuplicates) {
        return CollectionUtils.collate(a2, b2, ComparatorUtils.naturalComparator(), includeDuplicates);
    }

    public static <O> List<O> collate(Iterable<? extends O> a2, Iterable<? extends O> b2, Comparator<? super O> c2) {
        return CollectionUtils.collate(a2, b2, c2, true);
    }

    public static <O> List<O> collate(Iterable<? extends O> a2, Iterable<? extends O> b2, Comparator<? super O> c2, boolean includeDuplicates) {
        if (a2 == null || b2 == null) {
        ...
        int totalSize = a2 instanceof Collection && b2 instanceof Collection ? Math.max(1, ((Collection)a2).size() + ((Collection)b2).size()) : 10;
        CollatingIterator<O> iterator = new CollatingIterator<O>(c2, a2.iterator(), b2.iterator());
    ...
    public static <E> Collection<List<E>> permutations(Collection<E> collection) {
        PermutationIterator<E> it2 = new PermutationIterator<E>(collection);
        LinkedList<List<Object>> result = new LinkedList<List<Object>>();
        while (it2.hasNext()) {
            result.add((List<Object>)it2.next());
        }
        return result;
    }
    ...
    implements Iterable<O> {
        ...
        public SetOperationCardinalityHelper(Iterable<? extends O> a2, Iterable<? extends O> b2) {
            super(a2, b2);
            CollectionUtils.addAll(this.elements, a2);
            CollectionUtils.addAll(this.elements, b2);
    ...
    private static class CardinalityHelper<O> {
        ...
        public CardinalityHelper(Iterable<? extends O> a2, Iterable<? extends O> b2) {
            this.cardinalityA = CollectionUtils.getCardinalityMap(a2);
            this.cardinalityB = CollectionUtils.getCardinalityMap(b2);
        }
