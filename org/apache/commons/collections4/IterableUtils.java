...
public class IterableUtils {
    ...
    public static <E> Iterable<E> chainedIterable(Iterable<? extends E> a2, Iterable<? extends E> b2) {
        return IterableUtils.chainedIterable(new Iterable[]{a2, b2});
    }

    public static <E> Iterable<E> chainedIterable(Iterable<? extends E> a2, Iterable<? extends E> b2, Iterable<? extends E> c2) {
        return IterableUtils.chainedIterable(new Iterable[]{a2, b2, c2});
    }

    public static <E> Iterable<E> chainedIterable(Iterable<? extends E> a2, Iterable<? extends E> b2, Iterable<? extends E> c2, Iterable<? extends E> d2) {
        return IterableUtils.chainedIterable(new Iterable[]{a2, b2, c2, d2});
    }
    ...
    public static <E> Iterable<E> collatedIterable(final Iterable<? extends E> a2, final Iterable<? extends E> b2) {
        IterableUtils.checkNotNull(a2, b2);
        return new FluentIterable<E>(){

            @Override
            public Iterator<E> iterator() {
                return IteratorUtils.collatedIterator(null, a2.iterator(), b2.iterator());
            }
        };
    }

    public static <E> Iterable<E> collatedIterable(final Comparator<? super E> comparator, final Iterable<? extends E> a2, final Iterable<? extends E> b2) {
        IterableUtils.checkNotNull(a2, b2);
        return new FluentIterable<E>(){

            @Override
            public Iterator<E> iterator() {
                return IteratorUtils.collatedIterator(comparator, a2.iterator(), b2.iterator());
            }
        };
    }
    ...
    public static <E> Iterable<E> zippingIterable(final Iterable<? extends E> a2, final Iterable<? extends E> b2) {
        IterableUtils.checkNotNull(a2);
        IterableUtils.checkNotNull(b2);
        return new FluentIterable<E>(){

            @Override
            public Iterator<E> iterator() {
                return IteratorUtils.zippingIterator(a2.iterator(), b2.iterator());
            }
        };
    }
        ...
        return new FluentIterable<E>(){
            ...
            public Iterator<E> iterator() {
                ...
                for (int i2 = 0; i2 < others.length; ++i2) {
                    iterators[i2 + 1] = others[i2].iterator();
                }
    ...
    public static <O, R extends Collection<O>> List<R> partition(Iterable<? extends O> iterable, Factory<R> partitionFactory, Predicate<? super O> ... predicates) {
        ...
        for (O element : iterable) {
            ...
            for (int i3 = 0; i3 < numberOfPredicates; ++i3) {
                if (!predicates[i3].evaluate(element)) continue;
                ((Collection)partitions.get(i3)).add(element);
