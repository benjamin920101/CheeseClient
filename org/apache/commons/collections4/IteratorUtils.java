...
public class IteratorUtils {
    ...
    public static <E> ZippingIterator<E> zippingIterator(Iterator<? extends E> a2, Iterator<? extends E> b2) {
        return new ZippingIterator<E>(a2, b2);
    }

    public static <E> ZippingIterator<E> zippingIterator(Iterator<? extends E> a2, Iterator<? extends E> b2, Iterator<? extends E> c2) {
        return new ZippingIterator<E>(a2, b2, c2);
    }
    ...
    public static Iterator<?> getIterator(Object obj) {
        ...
        try {
            ...
            if (Iterator.class.isAssignableFrom(method.getReturnType()) && (it2 = (Iterator)method.invoke(obj, (Object[])null)) != null) {
                return it2;
            }
        }
