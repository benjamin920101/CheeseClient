...
implements Bag<E> {
    ...
    public boolean addAll(Collection<? extends E> coll) {
        ...
        while (i2.hasNext()) {
            boolean added = this.add(i2.next());
    ...
    public boolean removeAll(Collection<?> coll) {
        ...
        if (coll != null) {
            ...
            while (i2.hasNext()) {
                boolean changed = this.remove(i2.next(), 1);
    ...
    protected void doReadObject(Map<E, MutableInteger> map, ObjectInputStream in2) throws IOException, ClassNotFoundException {
        this.map = map;
    ...
    public String toString() {
        ...
        buf.append('[');
        Iterator<E> it2 = this.uniqueSet().iterator();
        while (it2.hasNext()) {
            E current = it2.next();
