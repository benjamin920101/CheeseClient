...
implements Bag<E> {
    ...
    public static <E> PredicatedBag<E> predicatedBag(Bag<E> bag2, Predicate<? super E> predicate) {
        return new PredicatedBag<E>(bag2, predicate);
    }

    protected PredicatedBag(Bag<E> bag2, Predicate<? super E> predicate) {
