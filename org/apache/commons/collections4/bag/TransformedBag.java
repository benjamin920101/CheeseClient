...
implements Bag<E> {
    ...
    public static <E> Bag<E> transformingBag(Bag<E> bag2, Transformer<? super E, ? extends E> transformer) {
        return new TransformedBag<E>(bag2, transformer);
    }

    public static <E> Bag<E> transformedBag(Bag<E> bag2, Transformer<? super E, ? extends E> transformer) {
        TransformedBag<E> decorated = new TransformedBag<E>(bag2, transformer);
        if (bag2.size() > 0) {
    ...
    protected TransformedBag(Bag<E> bag2, Transformer<? super E, ? extends E> transformer) {
