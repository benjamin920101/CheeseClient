...
Serializable {
    ...
    public K nextKey(K key) {
        ...
        SortedMap sm2 = (SortedMap)this.normalMap;
        Iterator<K> it2 = sm2.tailMap(key).keySet().iterator();
        it2.next();
        if (it2.hasNext()) {
            return it2.next();
        }
    ...
    extends AbstractSortedMapDecorator<K, V> {
        protected ViewMap(DualTreeBidiMap<K, V> bidi, SortedMap<K, V> sm2) {
            super(new DualTreeBidiMap<K, V>(sm2, bidi.reverseMap, bidi.inverseBidiMap));
        }
