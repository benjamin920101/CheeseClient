...
implements Iterator<E> {
    ...
    public ZippingIterator(Iterator<? extends E> a2, Iterator<? extends E> b2) {
        this(new Iterator[]{a2, b2});
    }

    public ZippingIterator(Iterator<? extends E> a2, Iterator<? extends E> b2, Iterator<? extends E> c2) {
        this(new Iterator[]{a2, b2, c2});
    }
