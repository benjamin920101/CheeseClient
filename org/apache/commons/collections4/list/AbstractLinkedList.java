...
implements List<E> {
    ...
    public boolean removeAll(Collection<?> coll) {
        ...
        while (it2.hasNext()) {
            if (!coll.contains(it2.next())) continue;
            it2.remove();
            modified = true;
        }
        return modified;
    ...
    public boolean addFirst(E o2) {
        this.addNodeAfter(this.header, o2);
        return true;
    }

    public boolean addLast(E o2) {
        this.addNodeBefore(this.header, o2);
        return true;
    }
