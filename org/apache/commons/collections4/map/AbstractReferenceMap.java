...
extends AbstractHashedMap<K, V> {
    ...
    protected void doWriteObject(ObjectOutputStream out) throws IOException {
        ...
        MapIterator<K, V> it2 = this.mapIterator();
        while (it2.hasNext()) {
            out.writeObject(it2.next());
            out.writeObject(it2.getValue());
        }
        out.writeObject(null);
    }

    @Override
    protected void doReadObject(ObjectInputStream in2) throws IOException, ClassNotFoundException {
        Object key;
        this.keyType = ReferenceStrength.resolve(in2.readInt());
        this.valueType = ReferenceStrength.resolve(in2.readInt());
        this.purgeValues = in2.readBoolean();
        this.loadFactor = in2.readFloat();
        int capacity = in2.readInt();
        this.init();
    ...
    extends WeakReference<T> {
        ...
        public WeakRef(int hash, T r2, ReferenceQueue<? super T> q2) {
            super(r2, q2);
            this.hash = hash;
        }
    ...
    extends SoftReference<T> {
        ...
        public SoftRef(int hash, T r2, ReferenceQueue<? super T> q2) {
            super(r2, q2);
            this.hash = hash;
        }
    ...
    static class ReferenceBaseIterator<K, V> {
        ...
        public boolean hasNext() {
            this.checkMod();
            while (this.nextNull()) {
                ReferenceEntry e2 = this.entry;
                int i2 = this.index;
                while (e2 == null && i2 > 0) {
                    e2 = (ReferenceEntry)this.parent.data[--i2];
                }
                this.entry = e2;
                this.index = i2;
                if (e2 == null) {
                ...
                this.nextKey = e2.getKey();
                this.nextValue = e2.getValue();
    ...
    extends AbstractHashedMap.HashEntry<K, V> {
        ...
        boolean purge(Reference<?> ref) {
            boolean r2 = ((AbstractReferenceMap)this.parent).keyType != ReferenceStrength.HARD && this.key == ref;
            boolean bl2 = r2 = r2 || ((AbstractReferenceMap)this.parent).valueType != ReferenceStrength.HARD && this.value == ref;
            if (r2) {
