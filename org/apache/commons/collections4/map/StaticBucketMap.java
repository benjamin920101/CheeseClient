...
extends AbstractIterableMap<K, V> {
    ...
    extends AbstractSet<K> {
        ...
        public boolean remove(Object obj) {
            ...
            synchronized (lock) {
                Node n2 = StaticBucketMap.this.buckets[hash];
                while (n2 != null) {
                    Object k2 = n2.getKey();
    ...
    private class BaseIterator {
        ...
        public boolean hasNext() {
            ...
            while (this.bucket < StaticBucketMap.this.buckets.length) {
                ...
                synchronized (lock) {
                    Node n2 = StaticBucketMap.this.buckets[this.bucket];
                    while (n2 != null) {
                        this.current.add(n2);
                        n2 = n2.next;
                    }
