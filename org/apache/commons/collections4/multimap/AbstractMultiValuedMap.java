...
implements MultiValuedMap<K, V> {
    ...
    public Collection<V> values() {
        Values vs2 = this.valuesView;
        return vs2 != null ? vs2 : (this.valuesView = new Values());
    }
    ...
    public boolean putAll(K key, Iterable<? extends V> values) {
        ...
        return it2.hasNext() && CollectionUtils.addAll(this.get(key), it2);
    }
    ...
    extends AbstractMap<K, Collection<V>> {
        ...
        public Collection<V> get(Object key) {
            ...
            Object k2 = key;
            return AbstractMultiValuedMap.this.wrappedCollection(k2);
        }
        ...
        extends AbstractSet<Map.Entry<K, Collection<V>>> {
            ...
            public boolean contains(Object o2) {
                return AsMap.this.decoratedMap.entrySet().contains(o2);
            }
    ...
    extends AbstractCollection<V> {
        ...
        public Iterator<V> iterator() {
            ...
            for (Object k2 : AbstractMultiValuedMap.this.keySet()) {
                chain.addIterator(new ValuesIterator(k2));
            }
            return chain;
        }
    ...
    extends AbstractMultiSet<K> {
        ...
        @Override
        public boolean contains(Object o2) {
            return AbstractMultiValuedMap.this.getMap().containsKey(o2);
        }
    ...
    implements Collection<V> {
        ...
        public boolean removeAll(Collection<?> c2) {
            ...
            boolean result = coll.removeAll(c2);
            if (coll.isEmpty()) {
                AbstractMultiValuedMap.this.remove(this.key);
            }
            return result;
        ...
        public boolean retainAll(Collection<?> c2) {
            ...
            boolean result = coll.retainAll(c2);
            if (coll.isEmpty()) {
                AbstractMultiValuedMap.this.remove(this.key);
            }
            return result;
        ...
        public <T> T[] toArray(T[] a2) {
            Collection coll = this.getMapping();
            if (coll == null) {
                return CollectionUtils.EMPTY_COLLECTION.toArray(a2);
            }
            return coll.toArray(a2);
        }
