...
extends AbstractBitwiseTrie<K, V> {
    ...
    public V get(Object k2) {
        TrieEntry<K, V> entry = this.getEntry(k2);
        return entry != null ? (V)entry.getValue() : null;
    }

    TrieEntry<K, V> getEntry(Object k2) {
        Object key = this.castKey(k2);
        if (key == null) {
            return null;
        }
        int lengthInBits = this.lengthInBits(key);
    ...
    private boolean selectR(TrieEntry<K, V> h2, int bitIndex, K key, int lengthInBits, Reference<Map.Entry<K, V>> reference) {
        ...
        if (!this.isBitSet(key, h2.bitIndex, lengthInBits)) {
            if (this.selectR(h2.left, h2.bitIndex, key, lengthInBits, reference)) {
                return this.selectR(h2.right, h2.bitIndex, key, lengthInBits, reference);
            }
        } else if (this.selectR(h2.right, h2.bitIndex, key, lengthInBits, reference)) {
            return this.selectR(h2.left, h2.bitIndex, key, lengthInBits, reference);
        }
        return false;
    }
    ...
    private void removeInternalEntry(TrieEntry<K, V> h2) {
        ...
        TrieEntry p2 = h2.predecessor;
        p2.bitIndex = h2.bitIndex;
        TrieEntry parent = p2.parent;
        TrieEntry trieEntry = child = p2.left == h2 ? p2.right : p2.left;
        if (p2.predecessor == p2 && p2.parent != h2) {
            p2.predecessor = p2.parent;
        }
        if (parent.left == p2) {
            parent.left = child;
        } else {
        ...
        p2.left = h2.left;
        p2.right = h2.right;
        if (AbstractPatriciaTrie.isValidUplink(p2.left, p2)) {
            p2.left.predecessor = p2;
        }
        if (AbstractPatriciaTrie.isValidUplink(p2.right, p2)) {
            p2.right.predecessor = p2;
        }
    }
    ...
    private void readObject(ObjectInputStream stream) throws IOException, ClassNotFoundException {
        ...
        for (int i2 = 0; i2 < size; ++i2) {
            Object k2 = stream.readObject();
            Object v2 = stream.readObject();
            this.put(k2, v2);
        }
    }
    ...
    extends RangeMap {
        ...
        public K firstKey() {
            ...
            this.fixup();
            TrieEntry e2 = null;
            e2 = this.fromKey == null ? AbstractPatriciaTrie.this.firstEntry() : AbstractPatriciaTrie.this.higherEntry(this.fromKey);
            Object k2 = first = e2 != null ? (Object)e2.getKey() : null;
            if (e2 == null || !AbstractPatriciaTrie.this.getKeyAnalyzer().isPrefix(this.prefix, this.offsetInBits, this.lengthInBits, first)) {
                throw new NoSuchElementException();
            }
            return first;
        }
        ...
        public K lastKey() {
            ...
            this.fixup();
            TrieEntry e2 = null;
            e2 = this.toKey == null ? AbstractPatriciaTrie.this.lastEntry() : AbstractPatriciaTrie.this.lowerEntry(this.toKey);
            Object k2 = last = e2 != null ? (Object)e2.getKey() : null;
            if (e2 == null || !AbstractPatriciaTrie.this.getKeyAnalyzer().isPrefix(this.prefix, this.offsetInBits, this.lengthInBits, last)) {
                throw new NoSuchElementException();
            }
            return last;
        }
    ...
    extends RangeMap {
        ...
        public K firstKey() {
            Object first;
            TrieEntry e2 = null;
            e2 = this.fromKey == null ? AbstractPatriciaTrie.this.firstEntry() : (this.fromInclusive ? AbstractPatriciaTrie.this.ceilingEntry(this.fromKey) : AbstractPatriciaTrie.this.higherEntry(this.fromKey));
            Object k2 = first = e2 != null ? (Object)e2.getKey() : null;
            if (e2 == null || this.toKey != null && !this.inToRange(first, false)) {
                throw new NoSuchElementException();
            }
            return first;
        }
        ...
        public K lastKey() {
            Object last;
            TrieEntry e2 = this.toKey == null ? AbstractPatriciaTrie.this.lastEntry() : (this.toInclusive ? AbstractPatriciaTrie.this.floorEntry(this.toKey) : AbstractPatriciaTrie.this.lowerEntry(this.toKey));
            Object k2 = last = e2 != null ? (Object)e2.getKey() : null;
            if (e2 == null || this.fromKey != null && !this.inFromRange(last, false)) {
                throw new NoSuchElementException();
            }
            return last;
        }
    ...
    implements OrderedMapIterator<K, V> {
        ...
        protected TrieEntry<K, V> previousEntry() {
            ...
            TrieEntry e2 = this.previous;
            if (e2 == null) {
                throw new NoSuchElementException();
            }
            this.previous = AbstractPatriciaTrie.this.previousEntry(e2);
    ...
    implements Iterator<E> {
        ...
        protected TrieEntry<K, V> nextEntry() {
            ...
            TrieEntry e2 = this.next;
            if (e2 == null) {
                throw new NoSuchElementException();
            }
            this.next = this.findNext(e2);
            this.current = e2;
            return e2;
        }
    ...
    extends AbstractCollection<V> {
        ...
        @Override
        public boolean contains(Object o2) {
            return AbstractPatriciaTrie.this.containsValue(o2);
        }
        ...
        public boolean remove(Object o2) {
            ...
            while (it2.hasNext()) {
                ...
                if (!AbstractBitwiseTrie.compare(value, o2)) continue;
                it2.remove();
                return true;
            }
            return false;
    ...
    extends AbstractSet<K> {
        ...
        @Override
        public boolean contains(Object o2) {
            return AbstractPatriciaTrie.this.containsKey(o2);
        }

        @Override
        public boolean remove(Object o2) {
            int size = this.size();
            AbstractPatriciaTrie.this.remove(o2);
    ...
    extends AbstractSet<Map.Entry<K, V>> {
        ...
        public boolean contains(Object o2) {
            ...
            TrieEntry candidate = AbstractPatriciaTrie.this.getEntry(((Map.Entry)o2).getKey());
            return candidate != null && candidate.equals(o2);
        }
